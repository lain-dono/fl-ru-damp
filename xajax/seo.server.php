 ...
 *
 * @param int $parent_section ID родителя раздела
 * @param int $direct_id
 *
 ...
 *
 * @param int|bool $parent_section если не false - загрузка формы создания подраздела
 *
 * @return object xajaxResponse
 */
 ...
 *  
 * @param int $section_id     ИД Раздела
 * @param int $parent_section ИД родителя если есть (для подразделов)
 *
 * @return object xajaxResponse
 */
 ...
 *
 * @param int $id если не null - загрузка формы создания редактирования
 *
 * @return object xajaxResponse
 */
