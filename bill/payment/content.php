...
<div class="b-layout b-layout__page">
    ...
    ?>
        ...
        <?php include $_SERVER['DOCUMENT_ROOT'].'/bill/payment/paysystems/tpl.mobilesys.php'; ?>        
        <?php include $_SERVER['DOCUMENT_ROOT'].'/bill/payment/paysystems/tpl.psys.php'; ?>
        <?php include $_SERVER['DOCUMENT_ROOT'].'/bill/payment/paysystems/tpl.terminal.php'; ?>
        <?php include $_SERVER['DOCUMENT_ROOT'].'/bill/payment/paysystems/tpl.card.php'; ?>
        <?php include $_SERVER['DOCUMENT_ROOT'].'/bill/payment/paysystems/tpl.bank.php'; ?>
        
        <?php include $_SERVER['DOCUMENT_ROOT']."/bill/payment/paysystems/{$bill->payment_template}"; //@see billing::setPaymentMethod()?>
    </div>
