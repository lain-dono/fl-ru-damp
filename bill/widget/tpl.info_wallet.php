<?php if (name_page($path) == 'bill') { // если выводим на странице личного счета?>
...
<?php 
    ...
    if (name_page($path) == 'payed' || name_page($path) == 'payed-emp') { // Страницы ПРО работодателя и фрилансера?>
