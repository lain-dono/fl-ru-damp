...
<div class="b-radio b-radio_layout_vertical walletTypes">
    <?php $ignore_wallet = array(); foreach (WalletTypes::getListWallets() as $wallet) {
     $ignore_wallet[] = $wallet['type'];
     ?>
    ...
    <?php foreach (WalletTypes::getAllTypes() as $type) {
