<?php if ($type == 'projects') { //if 1.2 0014574?>	 
<script>	 
kword = search_kwords;	 
</script>	 
<?php 
...
<div id="search-form">
    ...
    ?><a class="b-button b-button_flat b-button_flat_green b-page__ipad b-page__iphone" href="/public/?step=1&kind=1" onClick="_gaq.push(['_trackPageview', '/virtual/employer/button_project_create']); ga('send', 'pageview', '/virtual/employer/button_project_create'); yaCounter6051055reachGoal('proekt_dobavlen');">Опубликуйте проект</a><?php 
} ?>
                    ...
                    <div class="flt-block <?= isset($_SESSION['search_advanced'][$type]) ? '' : 'last';?>">
                          <div class="b-search <?php if ($view_advanced) {
    ?>b-search_margright_370<?php 
} else {
    ?>b-search_margright_200<?php 
} ?> b-search_marg_null_iphone">
                          ...
                          <div class="search-ext">
                              <?php if ($view_advanced) {
    ?><a href="javascript:void(0)" id="search-advanced-button"><?= $name_advanced_search;
    ?></a><?php 
}//if?>
