									...
									<tr class="qpr">
										<td valign="top" bgcolor="#FAFAFA" style="border-left: 1px solid #C6C6C6; border-right: 1px solid #C6C6C6; padding:10px;">
											...
											<tr valign="top">
												...
												<tr valign="top">
													<td style="text-align:left; padding-left: 20px;"><strong><?=$proj['name']?></strong> &nbsp;&nbsp; <?php $txt_cost = view_cost2($proj['cost'], '', '', '', $proj['cost_type']); $txt_time = view_time($proj['time_value'], $proj['time_type']);?><span class="money"><?=$txt_cost?></span><?php if ($txt_cost != '' && $txt_time != '') {
    ?>, <?php 
} ?><?=$txt_time?></td>
												</tr>
												<?php 
