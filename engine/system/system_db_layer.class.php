...
class system_db_layer
{
	 ...
	 */
    public static function connect($host, $user, $pass, $db, $sett = array())
    {
        ...
        $persistent = false;
        if (isset($sett['persistent'])) {
            $persistent = $sett['persistent'];
        }
...
class db_layer_statement
{
     ...
     * @return unknown
     */
    public function __construct(&$connection, $query, $params)
    {
