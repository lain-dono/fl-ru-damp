...
final class front
{
    ...
    public function exec_page($class, $die = false)
    {
        ...
        if (self::og('tpl')) {
            self::og('tpl')->set('pageClass', self::$d->page);
        }
        if (!$class['method']) {
        ...
        if (method_exists(self::$d, $method)) {
            ...
            //die(self::$d->action);
            if (self::og('tpl')) {
                self::og('tpl')->set('action', self::$d->action);
            }
            self::$d->$method();
...
//            exit();
     ...
     * @return 
     */
    public static function oc($name)
    {
     ...
     * @return 
     */
    public static function og($name)
    {
     ...
     * @return 
     */
    public static function os($name, &$obj)
    {
