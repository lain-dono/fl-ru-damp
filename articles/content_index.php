...
<div class="page-articles">
        ...
        ?>
            <div class="post-one" id="post_<?=$article['id']?>">
                <div class="post-rate" id="rate_<?=$article['id']?>">
                    <?php if ($uid && $uid != $article['user_id']) {
    ?>
    ...
    ?>
                                    <a href="/articles/?id=<?=$article['id']?>">
                                        <?php $star = intval($article['bookmark']) == 0 ? '0_empty' : ($article['bookmark'] != 1 ? intval($article['bookmark']) - 1 : 0);
    ?>
    ...
    ?>
        ...
        ?>
                                    ...
                                    <?php if ($uid && intval($article['comments_unread']) > 0 && $article['lastviewtime'] !== NULL) {
    ?>
