...
<div class="b-layout b-layout_padtop_20">
    ...
    ?>
		...
		<h3 class="b-layout__h3">Привязка авторизации на сайте к IP-адресу <?php if ($bind_ip_current == 't') {
    ?><span class="b-layout__txt b-layout__txt_color_6bb336 b-layout__txt_fontsize_15">включена</span><?php 
} else {
    ?><span class="b-layout__txt b-layout__txt_color_c10600 b-layout__txt_fontsize_15">выключена</span><?php 
} ?></h3>
