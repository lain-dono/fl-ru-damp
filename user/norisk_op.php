...
<div class="ops-one c">
    <div class="ops-one-cnt">
        <ul class="ops-i">
            <?php if ($edited) {
    ?>
                <li><img src="/images/ico-e-u.png" title="Отедактировано <?= $edited;
    ?>" alt="Редактировал <?= $edited;
    ?>" /></li>
            <?php 
} ?>
    ...
    ?>
                ...
                <?php /* !!! классы sbrmsgblock, editsbrblock, editFromSbr не существуют, необходимы для точной обработки логики вызывания через XAJAX функции редактирования нескольких отзывов*/?>
    ...
    ?>
                    <ul class="opsa-op editsbrblock" id="ops_edit_link_<?= $theme['id'] ?>">
                        <?php if (hasPermissions('users') || (strtotime($theme['posted_time']) + 3600 * 24 > time())) {
    ?>
