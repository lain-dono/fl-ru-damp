...
<div class="b-menu b-menu_line">
    ...
    ?>
        <li class="b-menu__item <?= $activ_tab == 1 ? 'b-menu__item_active' : '';
    ?> b-menu_portfolio-item" <?= $activ_tab == 1 ? 'data-menu-opener="true" data-menu-descriptor="profile-nav"' : '';
    ?>>
        ...
        if ((substr($user->tabs, 7, 1) == 1 && $hide_tu_for_others == false) || $hasPerm) {
            ...
            ?>        
        <li class="b-menu__item <?= $activ_tab == 2 ? 'b-menu__item_active' : '';
            ?> b-menu_services-item" <?= $activ_tab == 2 ? 'data-menu-opener="true" data-menu-descriptor="profile-nav"' : '';
            ?>>
    ...
    ?>
        <li class="b-menu__item <?= $activ_tab == 3 ? 'b-menu__item_active' : '';
    ?> b-menu_information-item" <?= $activ_tab == 3 ? 'data-menu-opener="true" data-menu-descriptor="profile-nav"' : '';
    ?>>
        ...
        if (substr($user->tabs, 4, 1) == 1 || (hasPermissions('users'))) {
            ...
            ?>
		<li class="b-menu__item b-menu__item_last <?= $activ_tab == 6 ? 'b-menu__item_active' : '';
            ?> b-menu_rating-item " <?= $activ_tab == 6 ? 'data-menu-opener="true" data-menu-descriptor="profile-nav"' : '';
            ?>>
