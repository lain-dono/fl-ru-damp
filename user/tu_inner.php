...
<div class="b-layout b-layout__cf b-layout_relative">
    ...
    ?>
        <figure class="i-pic i-pic_port_z-index_inherit <?php if ($user->is_pro == 'f') {
    ?>i-pic_tu<?php 
} else {
    ?>i-pic_tu-col-4<?php 
}
    ?>">
            ...
            <a href="<?php if ($el['is_blocked'] == 't') {
    echo 'javascript:void(0)';
} else {
    echo $url;
}
    ?>"
               class="b-pic__lnk b-pic__lnk_relative <?php if ($el['is_blocked'] == 't') {
    ...
    ?>"
                   class="b-pic__lnk <?php if ($el['is_blocked'] == 't') {
    ...
    ?>
                        ...
                        <?php if ($is_owner || $is_perm) {
    ?>
                            <a class="b-pic__lnk" href="<?php echo $edit_url;
    ?>" onClick="yaCounter6051055.reachGoal('republic_tu');">
    ...
    ?>
                        ...
                        <?php if ($el['active'] == 'f') {
    ?>Снята с публикации<?php 
}
    ?>

                        <?php if ($is_owner || $is_perm) {
    ?> <!-- Ссылка на редактирование только владельцу -->
                            <a class="b-button b-button_admin_edit" href="<?php echo $edit_url;
    ?>"></a>
                        <?php 
}
    ?>
