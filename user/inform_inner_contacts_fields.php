<?php
    ...
    if ($val = $user->$vmap) {
        ...
        ?>
                ...
                <?php if ($edit_date) {
    ?>
                    <img src="<?= strtotime('+7 days', $edit_date) > time() ? '/images/ico-e-a.png' : '/images/ico-e-o.png' ?>" alt="Отредактировано <?= date('d.m.Y в H.i', $edit_date);
    ?>"  title="Отредактировано <?= date('d.m.Y в H.i', $edit_date);
    ?>" />
                <?php 
} //if ?>    
                </td>
