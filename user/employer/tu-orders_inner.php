...
<div class="b-layout b-layout_pad_10_20">
    ...
    <div class="b-layout b-layout_float_right b-layout_width_240 b-page__desktop">
        <div class="b-layout__txt b-layout__txt_right"><a class="b-layout__link" href="<?php echo tservices_helper::getOrderCardUrl($order['id']);
        ?>#messages">Переписка в заказе</a><br>(<?php if ($count['all']) {
    ...
    <div class="b-layout__txt b-layout__txt_padbot_10 b-page__ipad b-page__iphone"><a class="b-layout__link" href="<?php echo tservices_helper::getOrderCardUrl($order['id']);
        ?>#messages">Переписка в заказе</a> (<?php if ($count['all']) {
    echo $count['all'].' '.ending($count['all'], 'сообщение', 'сообщения', 'сообщений');
    if ($count['new']) {
        echo ', <span class="b-layout__txt_color_6db335">'.$count['new'].' '.ending($count['new'], 'новое', 'новых', 'новых').'</span>';
    }
