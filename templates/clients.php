...
<a name="b-promo_clients"></a>
    ...
    ?><div id="promo-close-forever" class="b-promo__slide b-promo__slide_close b-promo__slide_bot_-15<?= $state ? ' b-promo__slide_hide' : '' ?>"><a class="b-promo__link b-promo__link_float_right" href="javascript:void(0)" onclick="mainPromoClose();">закрыть совсем&#160;<span class="b-promo__slide-arrow b-promo__slide-arrow_close"></span></a></div><?php 
} ?>
	</div>
</div><!-- b-promo_main -->