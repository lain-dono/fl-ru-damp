...
<?php 
                        ...
                        ?>
                        <?php if ($top['close_comments'] == 'f' || $top['user_id'] == $user_id) {
    ?>
    ...
    if (!($mod & (commune::MOD_ADMIN | commune::MOD_COMM_ACCEPTED | commune::MOD_COMM_AUTHOR))) {
        ?>href="error" onclick="alert('Вы не являетесь членом данного сообщества. Данная функция Вам недоступна.'); return false;"<?php
