 ...
 *
	 ...
	 */
	public function deposit(&$op_id, $dep_id, $ammount, $descr, $payment_sys = 0, $trs_sum = 0, $op_code = 12, $op_add = 0, $date = 'now()')
	{
	    global $DB;
 ...
 *
	 * @return string					возвращает сообщение об ошибке
	 */
	public function depositEx($dep_id, $ammount, $descr, $ucoms, $op_code = 13, $trs_sum = NULL, $payment_sys = NULL, $date = NULL)
	{
	    global $DB;
	 ...
	 * @param integer $sUid
	 */
	public function alphaBankGift($nSummR = 0, $sDate = '', $sUid = 0, $sLogin = '')
	{
	    global $DB;
 ...
 *
	 * @return string					возвращает сообщение об ошибке
	 */
	public function depositBonusEx($dep_id, $ammount, $descr, $ucoms, $op_code = 13, $date = NULL)
	{
	    global $DB;
	    $data = array(
			'billing_id' => $dep_id,
 ...
 *
	 ...
	 */
	public function is_dep_exists($billing_no)
	{
	 ...
	 */
    public function GetInfo($uid, $create = false)
    {
        global $DB;
 ...
 *
	 ...
	 */
	public function GetHistory($uid, $mode = 0)
	{
	    global $DB;
	    if ($mode == 1) {
 ...
 *
	 * @return array
	 */
	public function GetHistoryOpCodes($uid)
	{
	    global $DB;
 ...
 *
	 * @return array  Данные выборки 
	 */
	public function GetHistoryByFilter($uid, $filter)
	{
	    global $DB;
 ...
 *
	 * @return array  Данные выборки
	 */
	public function getHistoryType($uid, $type = false)
	{
	    if (!$type) {
	        return self::GetHistory($uid);
	    }
 ...
 *
	 ...
	 */
	public function checkDepositByNotCard($uid)
	{
	    global $DB;
 ...
 *
	 ...
	 */
	public function checkHistory($uid, $type)
	{
	    global $DB;
 ...
 *
	 * @return   boolean          TRUE - операции были, FALSE - нет
	 */
	public function checkPayOperation($uid)
	{
	    global $DB;
 ...
 *
	 ...
	 */
	public function getCountHistoryType($uid)
	{
	 ...
	 * @return integer					0
	 */
    public function Buy(&$id, $transaction_id, $op_code, $uid, $descr = '', $comments = '', $ammount = 1, $commit = 1, $promo_code = 0, $payment_sys = 0, $trs_sum = 0)
    {
        global $DB;
 ...
 *
	 * @return integer					0
	 */	
	public function BuyFromSMS(&$id, $transaction_id, $op_code, $uid, $descr, $comments, $sum, $commit = 1, $payment_sys = 7)
	{
	    global $DB;
	    if (!$transaction_id || $transaction_id != $this->check_transaction($transaction_id, $uid)) {
 ...
 *
	 * @return integer					0
	 */
	public function BuyFromBonus(&$id, $transaction_id, $op_code, $uid, $descr = '', $comments = '', $ammount = 1, $commit = 1)
	{
	    global $DB;
	    if (!$transaction_id || $transaction_id != $this->check_transaction($transaction_id, $uid)) {
	        $this->view_error('Невозможно завершить транзакцию');
	 ...
	 */
	public function ChangeOpcodes($bill_id, $new_opcode)
	{
 ...
 *
	 ...
	 */
	public function Gift(&$id, &$gid, $transaction_id, $op_code, $fid, $tid, $descr = '', $comments = '', $ammount = 1)
	{
	    global $DB;
 ...
 *
	 * @return integer
	 */
	public function GiftBonus(&$id, &$gid, $transaction_id, $op_code, $fid, $tid, $descr = '', $comments = '', $ammount = 1)
	{
	    global $DB;
	    if (!$transaction_id || $transaction_id != $this->check_transaction($transaction_id, $fid)) {
	        $this->view_error('Невозможно завершить транзакцию');
 ...
 *
	 ...
	 */
	public function GetOperationClassName($bill_id = 0, $opcode = 0)
	{
	    global $DB;
 ...
 *
	 ...
	 */
	public function GetHistoryInfo($bill_id, $uid, $mode = 1)
	{
 ...
 *
	 ...
	 */
	public function GetStatPS($ps, $from_date = '2000-01-01', $to_date = 'now()', $op_code = 12)
	{
	    global $DB;
	    $ret = $DB->row(
 ...
 *
	 * @return array					[сумма в валюте платежной системы, сумма в FM]
	 */
	public function GetStatPSEx($from_date = '2000-01-01', $to_date = 'now()', $op_codes = array(12))
	{
	    global $DB;
     ...
     * @return real сумма
     */
    public function GetStatOst($from_date = '2000-01-01', $to_date = 'now()', $ignore_staff = false)
    {
        global $DB;
     ...
     *               )
     */
    public function getStatOverall($from_date = '2000-01-01', $to_date = '2000-01-01', $ignore_staff = false)
    {
        $this->_getIgnoreInStats();
     ...
     */
    public function getStatTransferOursAlien($from_date = '2000-01-01', $to_date = '2000-01-01', $direction = true)
    {
        $this->_getIgnoreInStats();
 ...
 *
     ...
     *                              ]
	 */
    public function GetStatDeal($from_date = '2000-01-01', $to_date = 'now()')
    {
        global $DB;
 ...
 *
	 ...
	 */
    public function GetStatDealMoney($from_date = '2000-01-01', $to_date = 'now()')
    {
        global $DB;
        $wmz = 0;
        $wmr = 0;
     ...
     */
    public function getStatOPProject($from_date = '2000-01-01', $to_date = 'now()', $type = '', $is_konkurs = false, $is_bonus = false)
    {
 ...
 *
	 ...
	 */
	public function GetStatOP($op, $from_date = '2000-01-01', $to_date = 'now()', $addit = '', $join = '', $app = '')
	{
	    global $DB;
    ...
    * @return arrray				[сумма в FM, кол-во операций]
    */
    public function GetStatOPEx($from_date = '2000-01-01', $to_date = 'now()', $ignore_staff = false)
    {
        global $DB;
     ...
     * @return array [сумма в FM, кол-во операций]
     */
    public function GetPROStat($from_date = '2000-01-01', $to_date = 'now()', $emp = 1)
    {
        global $DB;
 ...
 *
	 ...
	 */
	public function GetUsersByAkOp($akop, $fdate, $tdate, $sDomainId = '')
	{
	    global $DB;
 ...
 *
	 * @return array
	 */
	public function getPayUsers($get, $ds, $de, $filter = false)
	{
	    global $DB;
	    if ($filter) {
	    ...
	    if ($get['pt']) {
	        $orders = array_merge($orders, array(47));
	    }
	    if ($get['pp']) {
	        $acc_op = array(8, 53, 113, 192);
	    }
	    if ($get['gift']) {
	    ...
	    if ($get['pf']) {
	        $user_fp = array_merge($user_fp, array(10, 11, 17, 18));
	    }
	    if ($get['pca']) {
	        $user_fp = array_merge($user_fp, array(19, 25, 29));
	    }
	    if ($get['pci']) {
	        $user_fp = array_merge($user_fp,  array(20, 30));
	    }
	    if ($get['tr']) {
	        $acc_op = array_merge($acc_op, array(21, 23));
	    }
	    if ($get['con']) {
	        $acc_op = array_merge($acc_op, array(9));
	    }
	    if ($get['uprj']) {
	        $acc_op = array_merge($acc_op, array(7));
	    }
	    if ($get['oprj']) {
	        $acc_op = array_merge($acc_op, array(61, 62));
	    }
	    if ($get['bonus']) {
	    ...
	    if ($get['chlogin']) {
	        $acc_op = array_merge($acc_op, array(70));
	    }
	    if ($get['unlock']) {
	        $acc_op = array_merge($acc_op, array(74));
	    }
	    if ($get['askmanager']) {
	        $acc_op = array_merge($acc_op, array(82));
	    }

	    if ($get['specs']) {
	        $acc_specs = array_merge($acc_specs, array(80));
	    }
	    if ($get['rating']) {
	        $acc_op = array_merge($acc_op, array(75));
	    }
 ...
 *
	 * @return integer
	 */
	public function ammountDay($ammount, $days, $period = 1)
	{
	    if ($period <= 1) {
	        return 0;
	    }
 ...
 *
	 ...
	 */
	public function GetUsersPayments($ps, $fdate, $tdate, $is_ret_data = true)
	{
	    global $DB;
	    if (!$ps) {
	        return 0;
 ...
 *
	 ...
	 */
	public function start_transaction($user_id, $tr_id = 0, $yd = false)
	{
	    global $DB;
	    if ($tr_id) {
	        if ($tr_id == $this->check_transaction($tr_id, $user_id)) {
	            return $tr_id;
	        }
	    }
	    if ($yd) {
	 ...
	 */
	public function view_error($error)
	{
 ...
 *
	 ...
	 */
	public function check_transaction($tr_id, $user_id)
	{
	    global $DB;
 ...
 *
	 ...
	 */
	public function commit_transaction($tr_id, $user_id, $op_id)
	{
	    global $DB;
	    if ($op_id == 'null') {
 ...
 *
	 ...
	 */
	public function transfer($uid, $gid, $sum, $transaction_id, $comments, $commit = true, $trs_sum = 0)
	{
	    global $DB;
	    $user_transfer = $gid;
	    if (!$transaction_id || $transaction_id != $this->check_transaction($transaction_id, $uid)) {
 ...
 *
	 * @return array
	 */
	public function GetTransfers($fdate, $tdate)
	{
	    global $DB;
 ...
 *
	 * @return array
	 */
	public function GetGifts($fdate, $tdate)
	{
	    global $DB;
 ...
 *
	 ...
	 */
	public function GetOrderInfo($bill_id, $uid = NULL, $mode = 1)
	{
	    global $DB;
	 ...
	 */
    public function CommitReserved($eid, $reserve_id, $descr, $op_code = 37, $sum = NULL, $comments = NULL)
    {
        global $DB;
 ...
 *
	 * @return array
	 */
	public function GetMoneyTop100($users_table = 'users', $period_from = '1970-01-01', $period_to = 'NOW()')
	{
	    global $DB;
 ...
 *
	 * @return array
	 */
	public function GetMoneyTop100UsersByPeriod($uarray, $period_from = '2000-01-01', $period_to = 'NOW()')
	{
	    global $DB;
 ...
 *
	 ...
	 */
	public function SearchPaymentByDescr($text)
	{
	    global $DB;
 ...
 *
	 ...
	 */
	public function GetUserByAccID($id)
	{
	    global $DB;
 ...
 *
	 * @return array 			Данные выборки
	 */
	public function searchBillHistory($sdate, $edate, $sort, $type = false, $page = 1, &$pages, &$total, $count = 10)
	{
	    global $DB;
	    $uid = get_uid(false);
 ...
 *
	 * @return array Данные выборки
	 */
	public function searchBillEvent($sdate, $edate)
	{
	    global $DB;
	    $uid = get_uid(false);
 ...
 *
	 * @return array 			 Данные выборки
	 */
	public function getDateBillOperation($month = false, $uid = false, $type = false, $year = false)
	{
	    global $DB;
	    if (!$month) {
	        $month = date('m');
     ...
     * @return array
     */
    public function getSmsInfo($from_date = '2009-01-01', $to_date = 'now()')
    {
        global $DB;
     ...
     * @return array
     */
    public function getSmsInfoInCSV($from_date = '2009-01-01', $to_date = 'now()')
    {
        global $DB;
 ...
 *
	 * @return array
	 */
	public function billHistorySort($sort, $uid)
	{
	    global $DB;
	    if (!$month) {
	        $month = date('m');
 ...
 *
	 ...
	 */
    public function GetStatTestBuyPro($fdate, $tdate)
    {
        global $DB;
 ...
 *
	 ...
	 */
    public function GetStatBonuses($fdate, $tdate)
    {
        global $DB;
 ...
 *
	 * @return string			сообщение об ошибке
	 */
	public function Blocked($uid, $opid)
	{
	    $class = $this->GetOperationClassName($opid);
	    if ($class) {
	        require_once $_SERVER['DOCUMENT_ROOT'].'/classes/'.$class.'.php';
	 ...
	 */
	public function unBlocked($uid, $opid)
	{
	    $class = $this->GetOperationClassName($opid);
 ...
 *
	 ...
	 */
	public function getStatsPRO($from_date = '2000-01-01', $to_date = 'now()')
	{
	    global $DB;
	    $f_sql = "SELECT 
 ...
 *
	 ...
	 */
    public function getLastOperations($uid)
    {
        global $DB;
        $sql = '
 ...
 *
	 ...
	 */
	public function getSuccessInfo($data)
	{
	    if ($data['op_code'] == 12) {
 ...
 *
	 ...
	 */
	public function getPaymentSysName($sys)
	{
	    switch ($sys) {
 ...
 *
	 ...
	 */
	public function getLastSumHistory($date)
	{
	    global $DB;
	 ...
	 */
	public function setBlockMoney($uid, $block = true)
	{
	    global $DB;
	    if (!$uid) {
	        return false;
     ...
     */
    public function addAttach($files, $dir, $formatted = false)
    {
        global $DB;
        if (!$files) {
            return 0;
     ...
     */
    public function addAttach2($attach)
    {
        global $DB;
        if (!$attach) {
            return 0;
     ...
     * @return array
     */
    public function getAllAttach($attach_id = NULL)
    {
        global $DB;
        $where = "WHERE aa.account_id = {$this->id} AND aa.deleted = FALSE";
        if ($attach_id) {
            $where .= " AND aa.id IN ($attach_id)";
        }
        $ret = NULL;
        $sql = "
     ...
     */
    public function GetStatSbrInOut($from_date = '2000-01-01', $to_date = 'now()', $op_codes = array(36, 38, 77, 79))
    {
        global $DB;
     ...
     * @return array массив или NULL
     */
    public function GetStatSbrCommission($from_date = '2000-01-01', $to_date = 'now()')
    {
        global $DB;
