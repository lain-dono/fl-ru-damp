...
class lm
{
    ...
    */
    public function UpdateDocumentsSend($id, $status, $date)
    {
        global $DB;
    ...
    */
    public function UpdateDocumentsBack($id, $status, $date)
    {
        global $DB;
    ...
    */
    public function AddDocumentRecord($user_id, $op_id)
    {
        global $DB;
    ...
    */
    public function UpdateFiles($id, $file_sf, $file_act)
    {
        global $DB;
	 ...
	 */
    public function GetLMRequests($fdate, $tdate, $search = NULL, $sort = NULL, $date_search_type = '11')
    {
        global $DB;
        if ($sort) {
