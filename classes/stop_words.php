...
class stop_words
{
     ...
     * @var array
     */
    public static $site_allow = array('words', 'regex');
     ...
     */
    public function setStopWords($sWords = null)
    {
     ...
     */
    public function setStopRegex($sRegex = null)
    {
     ...
     * @return string
     */
    public function replace($sText = '', $replace_mode = 'html', $admin_mode = null, $regex_prefix = '')
    {
        return $sText;
     ...
     */
    public function calculateRegexNoWords()
    {
     ...
     */
    public function _calculate($sText = '', $regex_prefix = 'suspect', $calc_words = true)
    {
        $nReg = 0;
        $nStop = 0;
     ...
     * @return string
     */
    public function _callbackLinkReplace($matches)
    {
     ...
     * @return string
     */
    public function _callbackReplace($matches)
    {
        $sTxt = $matches[0];
     ...
     */
    public function validateAdminStopRegex($sRegex = '')
    {
        $sError = '';
        $aRegex = explode("\n", $sRegex);
     ...
     */
    public function updateAdminStopWords($sWords = '')
    {
     ...
     * @return bool true - успех, false - провал
     */
    public function updateAdminStopRegex($sRegex = '')
    {
     ...
     * @return array
     */
    public function getAdminStopWords($bMemBuf = true)
    {
     ...
     * @return array
     */
    public function getAdminStopRegex($bMemBuf = true)
    {
