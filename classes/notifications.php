...
class notifications
{
     ...
     * @return array
     */
    public static function getFrlGroupTip()
    {
    ...
    public static function getEmpGroupTip()
    {
     ...
     * null - в случае ошибки.
     * 
     * @param bool $ajax вызов функции ajax'ом
     */
