...
class cardpay extends account
{
     ...
     * @return string
     */
    public function checkResultsByDate()
    {
     ...
     *
     * @param int    $code внутренний (наш) код ошибки.
     * @param string $msg  описание ошибки (тоже для нас).
     */
    public function fail($code, $msg = null)
    {
        switch ($code) {
     ...
     *
     * @param int    $billnumber номер операции в системе Assist.
     * @param string $packetdate дата операции по Assist.
     */
    public function success($billnumber, $packetdate)
    {
        $ret = '<?xml version="1.0" encoding="UTF-8"?>'
