...
class SeoTags
{
     ...
     * @param array $item
     */
    public function initByPortfolio($item, $spec_text)
    {
     ...
     */
    public function initFreelancers($prof_id, $page = 1, $is_spec = true)
    {
        if ($prof_id) {
            $this->seo_value = new SeoValues();
     ...
     * @param bool $is_spec Флаг раздел или специализация
     */
    public function initTserviceList($tservice_prof_id, $is_spec = true, $count = 0, $min_price = 0)
    {
