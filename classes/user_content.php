...
class user_content extends admin_parent
{
     ...
     * @var array
     */
    public static $site_allow = array(15 => 'choose', 'shifts', 'streams', 'blocked', 'stream', 'frames');
     ...
     * @var array
     */
    public static $aNoApproved = array(
        self::MODER_PROFILE,
        self::MODER_PORTF_CHOISE,
        self::MODER_USER_UNITED,
    );
     ...
     * @var array
     */
    public static $aNoRejected = array(
        self::MODER_PROFILE,
        self::MODER_PRJ_DIALOG,
        self::MODER_PORTF_CHOISE,
        self::MODER_PORTFOLIO,
        self::MODER_USER_UNITED,
    );
     ...
     */
    public function __construct($uid = 0, $user_permissions = array(), $items_pp = 20)
    {
        $this->curr_uid = $uid;
     ...
     */
    public function checkStream($content_id = 0, $stream_id = '', $user_id = 0, &$aStream = 0, $nResolveCnt = 0)
    {
        $bRet = false;
        $bFound = false;
     ...
     */
    public function releaseDelayedStreams()
    {
     ...
     * @param int    $user_id    UID пользователя
     */
    public function releaseStream($content_id = 0, $stream_id = '', $user_id = 0)
    {
        if ($this->content_streams === false || $this->first_update === false || $this->last_update === false) {
            $this->_initStreams();
     ...
     */
    public function sendNotification($user_id = 0, $from_id = 0, $content_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $reason = '')
    {
        global $DB;
        if ($action != 2) {
            return;
     ...
     * @return bool true - успех, false - провал
     */
    public function resolveContent($stream_id = '', $user_id = 0, $from_id = 0, $content_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
     ...
     * @param string $is_sent    было ли отправлено уведомление
     */
    public function unblock($content_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $is_sent = '')
    {
        switch ($content_id) {
            case self::MODER_BLOGS:
                // Блоги: посты и комментарии
     ...
     * @param string $reason    причина удаления
     */
    public function resolveMessages($stream_id = '', $user_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
        $bRet = false;
        $DB = new DB('plproxy');
     ...
     * @return bool true - успех, false - провал
     */
    public function resolveBlogs($stream_id = '', $user_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
        $bRet = false;
     ...
     * @return bool true - успех, false - провал
     */
    public function resolveCommunity($stream_id = '', $user_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
        $bRet = false;
        $sQuery = 'UPDATE moderation SET moder_num = ?i, status = ?i WHERE rec_id = ?i AND rec_type = ?i AND stream_id = ? RETURNING rec_id';
     ...
     * @param string $reason    причина удаления
     */
    public function resolveSbrReqv($stream_id = '', $user_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
        $bRet = false;
        $sQuery = 'UPDATE moderation SET moder_num = ?i, status = ?i WHERE rec_id = ?i AND rec_type = ?i AND stream_id = ? RETURNING rec_id';
     ...
     * @param string $reason    причина удаления
     */
    public function resolveTServices($stream_id = '', $user_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
        $bRet = false;
        $sQuery = 'UPDATE moderation SET moder_num = ?i, status = ?i WHERE rec_id = ?i AND rec_type = ?i AND stream_id = ? RETURNING rec_id';
     ...
     * @param string $reason    причина удаления
     */
    public function resolveProjects($stream_id = '', $user_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
        $bRet = false;
        $sQuery = 'UPDATE moderation SET moder_num = ?i, status = ?i WHERE rec_id = ?i AND rec_type = ?i AND stream_id = ? RETURNING rec_id';
     ...
     * @param type $reason
     */
    public function markProjectBlocked($stream_id = '', $rec_id = 0)
    {
        $sQuery = 'UPDATE moderation SET moder_num = ?i, status = ?i WHERE rec_id = ?i AND rec_type = ?i AND stream_id = ? RETURNING rec_id';
     ...
     * @param string $reason    причина удаления
     */
    public function resolvePrjOffers($stream_id = '', $user_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
        $bRet = false;
        $sQuery = 'UPDATE moderation SET moder_num = ?i, status = ?i WHERE rec_id = ?i AND rec_type = ?i AND stream_id = ? RETURNING rec_id';
     ...
     * @param string $reason    причина удаления
     */
    public function resolveArtCom($stream_id = '', $user_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
        $bRet = false;
        $sQuery = 'UPDATE moderation SET moder_num = ?i, status = ?i WHERE rec_id = ?i AND rec_type = ?i AND stream_id = ? RETURNING rec_id';
     ...
     * @param string $reason    причина удаления
     */
    public function resolveProfile($stream_id = '', $user_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
        $bRet = false;
     ...
     * @return bool true - успех, false -провал
     */
    public function editProfile($rec_id = 0, $new_val = '')
    {
     ...
     * @param string $reason    причина удаления
     */
    public function resolvePrjDialog($stream_id = '', $user_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
        $bRet = false;
        $sQuery = 'UPDATE moderation SET moder_num = ?i, status = ?i WHERE rec_id = ?i AND rec_type = ?i AND stream_id = ? RETURNING rec_id';
     ...
     * @param string $reason    причина удаления
     */
    public function resolveContestCom($stream_id = '', $user_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
        $bRet = false;
        $sQuery = 'UPDATE moderation SET moder_num = ?i, status = ?i WHERE rec_id = ?i AND rec_type = ?i AND stream_id = ? RETURNING rec_id';
     ...
     * @param string $reason    причина удаления
     */
    public function resolvePortfChoice($stream_id = '', $user_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
        $bRet = false;
     ...
     * @param string $reason    причина удаления
     */
    public function resolvePortfolio($stream_id = '', $user_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
        $bRet = false;
        $sQuery = 'UPDATE moderation SET moder_num = ?i, status = ?i WHERE rec_id = ?i AND rec_type = ?i AND stream_id = ? RETURNING rec_id';
     ...
     * @param string $reason    причина удаления
     */
    public function resolveSdelau($stream_id = '', $user_id = 0, $from_id = 0, $rec_id = 0, $rec_type = 0, $action = 1, $is_sent = '', $reason = '')
    {
        $bRet = false;
        $sQuery = 'UPDATE moderation SET moder_num = ?i, status = ?i WHERE rec_id = ?i AND rec_type = ?i AND stream_id = ? RETURNING rec_id';
     ...
     */
    public function chooseContent($content_id = 0, $stream_id = '', $stream_num = 0, $limit = 10)
    {
     ...
     * @return string
     */
    public function _getChooseContentUnitedSql($aContentId = array(), $nStreamsCnt = 0, $nStreamNum = 0, $nLimit = 0, $bStatus = false)
    {
     ...
     */
    public function checkContent($content_id = 0, $stream_id = '', $rec_id = 0)
    {
        $bRet = false;
     ...
     */
    public function getContent($content_id = 0, $stream_id = '', $status = 0, $last_id = 0, $limit = 10)
    {
        $aReturn = array();
     ...
     * @param type $aReturn
     */
    public function _getPrjOffersAttach(&$aReturn = array())
    {
     ...
     * @param type $aReturn
     */
    public function _getBlogsAttachPoll(&$aReturn = array())
    {
        require_once $_SERVER['DOCUMENT_ROOT'].'/classes/blogs.php';
     ...
     * @param type $aReturn
     */
    public function _getCommunityAttachPoll(&$aReturn = array())
    {
        // ответы на опросы -----
        $ids = '';
        $lnk = array();
     ...
     * @param type $aReturn
     */
    public function _getProjectsAttachSpecs(&$aReturn = array())
    {
        require_once $_SERVER['DOCUMENT_ROOT'].'/classes/projects.php';
     ...
     * @return array
     */
    public function getBlockedMessages($filter = array(), $last_id = 2147483647, $limit = 10)
    {
        $DB = new DB('plproxy');
        $aFilter = array();
     ...
     * @return array
     */
    public function getBlockedBlogs($filter = array(), $last_id = 2147483647, $limit = 10)
    {
     ...
     * @return array
     */
    public function getBlockedCommunity($filter = array(), $last_id = 2147483647, $limit = 10)
    {
        $sUser = !empty($filter['login']) ? ' WHERE '.(empty($filter['login_ex']) ? "u.login ILIKE  '%{$filter['login']}%'" : "u.login = '{$filter['login']}'") : '';
     ...
     * @return array
     */
    public function getBlockedProjects($filter = array(), $last_id = 2147483647, $limit = 10)
    {
     ...
     * @return array
     */
    public function getBlockedPrjOffers($filter = array(), $last_id = 2147483647, $limit = 10)
    {
        $sUser = !empty($filter['login']) ? ' WHERE '.(empty($filter['login_ex']) ? "u.login ILIKE  '%{$filter['login']}%'" : "u.login = '{$filter['login']}'") : '';
     ...
     * @return array
     */
    public function getBlockedArtCom($filter = array(), $last_id = 2147483647, $limit = 10)
    {
        $sAnd = !empty($filter['login']) ? ' AND '.(empty($filter['login_ex']) ? "u.login ILIKE  '%{$filter['login']}%'" : "u.login = '{$filter['login']}'") : '';
     ...
     * @return array
     */
    public function getBlockedPrjDialog($filter = array(), $last_id = 2147483647, $limit = 10)
    {
        $sAnd = !empty($filter['login']) ? ' AND '.(empty($filter['login_ex']) ? "u.login ILIKE  '%{$filter['login']}%'" : "u.login = '{$filter['login']}'") : '';
     ...
     * @return array
     */
    public function getBlockedContestCom($filter = array(), $last_id = 2147483647, $limit = 10)
    {
        $sAnd = !empty($filter['login']) ? ' AND '.(empty($filter['login_ex']) ? "u.login ILIKE  '%{$filter['login']}%'" : "u.login = '{$filter['login']}'") : '';
     ...
     * @return array
     */
    public function getBlockedPortfolio($filter = array(), $last_id = 2147483647, $limit = 10)
    {
        $sAnd = !empty($filter['login']) ? ' AND '.(empty($filter['login_ex']) ? "u.login ILIKE  '%{$filter['login']}%'" : "u.login = '{$filter['login']}'") : '';
     ...
     * @return array
     */
    public function getBlockedSdelau($filter = array(), $last_id = 2147483647, $limit = 10)
    {
        $sAnd = !empty($filter['login']) ? ' AND '.(empty($filter['login_ex']) ? "u.login ILIKE  '%{$filter['login']}%'" : "u.login = '{$filter['login']}'") : '';
     ...
     * @return array
     */
    public function getProjectsPer24($aEmpId = array())
    {
     ...
     */
    public function _getCommentsAttach(&$aComments = array(), $sContentId = '', $sTable = '', $sFileTable = '', $sIdFld = '', $sFileIdFld = '')
    {
     ...
     */
    public function chooseStream($content_id = 0, $stream_id = '', $user_id = 0)
    {
        $sStreamId = '';
     ...
     * @return array
     */
    public function getContentsForUser()
    {
        $aReturn = array();
     ...
     * @return array
     */
    public function getBlockedContentsForUser()
    {
        $aReturn = array();
     ...
     * @return array
     */
    public function getStreamsForUser($user_id = 0)
    {
        $aReturn = array();
     ...
     */
    public function updateStreamsForUser()
    {
        $aReturn = array();
     ...
     * 
     * @param bool $init true - пересохранить данные, false - только если есть изменения
     */
     ...
     * @return bool true - успех, false - провал
     */
    public function updateShiftsContents($aStreams = array())
    {
     ...
     * @return bool true - успех, false - провал
     */
    public function validShiftsContents($mParam = '')
    {
        $bRet = true;
     ...
     * @return array
     */
    public function getShiftsContents()
    {
     ...
     * @return bool true - успех, false - провал
     */
    public function insertShifts($aFrom = array(), $aTo = array())
    {
        $bRet = false;
     ...
     * @return bool true - успех, false - провал
     */
    public function updateShifts($aId = array(), $aFrom = array(), $aTo = array())
    {
        $bRet = false;
     ...
     * @return bool true - успех, false - провал
     */
    public function deleteShifts($mShiftId = array())
    {
        $bRet = false;
     ...
     * @return bool true - успех, false - провал
     */
    public function validTimes($aTimes = array())
    {
        $bRet = true;
     ...
     */
    public function hasPermissions($site = '')
    {
     ...
     * @return bool true - имеет, false - не имеет
     */
    public function hasContentPermissions($sId = 0, $aPermissions = null)
    {
        $bRet = $bFound = false;
     ...
     */
    public function getReasonGroup($type, $rec_type)
    {
        $group = 0;
        switch ($type) {
            case self::MODER_MSSAGES:
     ...
     * @return array
     */
    public function getStreamsQueueCounts()
    {
        $memBuff = new memBuff();
     ...
     * @return array
     */
    public function getStreamCounters($nContentId = 0, $bNumsOnly = false, &$bShow = false)
    {
        $aReturn = array();
        $bShow = false;
     ...
     */
    public static function sendToModeration($rec_id, $rec_type, $data = null)
    {
