...
class LocalDateTime extends DateTime
{
     ...
     * 
     * @return bool true - Текущий день выходной
     */
     ...
     * 
     * @return bool true - Текущий день рабочий
     */
     ...
     * Проверяем в текущей дате стандартный выходной или нет.
     * 
     * @return bool true - Текущий день выходной (праздничный)
     */
     ...
     * 
     * @param int $day Сколько рабочих дней необходимо плюсануть
     */
     ...
     *
     * @param int $endDate дата в формате UnixTime
     */
