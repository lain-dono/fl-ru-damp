...
<!--                    <li class="cl-form-tags">
                ...
                <div class="cl-form-files c" style="<?if (!isset($alert['attach']) && !$_POST['is_attached']) echo 'display: none;'; ?>">
                    ...
                    <?php if (!empty($alert['attach'])) {
    ?>
                        <div id="error_file" onclick="this.style.display = 'none'" class="tip tip-t2" style="top: <?=(40 + (count($this->_post_msg['attaches']) * 27))?>px; left: 10px;"><div class="tip-in"><div class="tip-txt"><div class="tip-txt-in"><span class="middled"><strong><?= $alert['attach'];
    ?></strong></span></div></div></div></div>
                    <?php 
} //if ?>  
                    <?php /*if (isset($alert['attach'])) echo view_error($alert['attach']); */?>
                </div>
                <div class="cl-form-video" style="<?if (!isset($alert['yt_link']) && !$_POST['yt_link']) echo 'display: none;'; ?>">
                    ...
                    <?php if (!empty($alert['yt_link'])) {
    ?>
                        <div id="yt_error" class="tip tip-t2" style="top: 20px; left: 10px;"><div class="tip-in"><div class="tip-txt"><div class="tip-txt-in"><span class="middled"><strong><?= $alert['yt_link'];
    ?></strong></span></div></div></div></div>
                    <?php 
} ?>
                    <?php /*if (isset($alert['yt_link'])) echo view_error($alert['yt_link']); */?>
                </div>
                <div class="cl-form-btns">
	                <?php if (!empty($alert['msgtext'])) {
    ?>
