...
class CommentsCommune extends TComments
{
    ...
    protected $_access = array(1 => array('update' => 'Отредактировано модератором',
                                  'delete' => 'Комментарий удален модератором', ),
                               2 => array('update' => 'Отредактировано создателем сообщества',
                                  'delete' => 'Комментарий удален создателем сообщества', ),
                               3 => array('update' => 'Отредактировано модератором сообщества',
                                  'delete' => 'Комментарий удален модератором сообщества', ),
                               4 => array('delete' => 'Комментарий удален автором поста'),
                        );
    /**
