...
class tservices_helper
{
    ...
    {
        if (!$file) {
            return sprintf(self::url('no_photo_path'), WDCPREFIX);
        }
    ...
    public static function isUserOrderWhiteList($login = null)
    {
        ...
        if (!isset($order_whitelist) || empty($order_whitelist)) {
            return true;
        }
     ...
     *
     * @return bool - разрешен/запрещен доступ
     */
    ...
    {
        return sprintf(self::url('order_card_url'), $order_id);
    }
    ...
    public static function getOrderStatusUrl($order_id, $status, $uid = null)
    {
        ...
        return sprintf(self::url('order_change_status'), $order_id, $status, $hash);
    }
    ...
    {
        return sprintf(self::url('new_order_url'), $code);
    }
    ...
    public static function getFeedbackUrl($id, $login = null)
    {
        ...
        return sprintf(self::url('feedback_url'), $login, $id);
    }
    ...
    public static function getGuestPersonalOrderUrl($login = null)
    {
        ...
        return sprintf(self::url('guest_porder_url'), $login);
    }
    ...
    public static function getPersonalOrderUrl($login)
    {
        ...
        return sprintf(self::url($url_key), $login);
    }
}
