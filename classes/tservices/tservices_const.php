...
class tservices_const
{
    ...
    protected static $_placeholder = array(
    ...
    protected static $_button = array(
    ...
    public static function enum($name, $const)
    {
        if (!isset(self::${'_'.$name})) {
            return false;
        }
        $a = self::${'_'.$name};
