 ...
 *
	 * @return integer
	 */
    public function GetLastGift(&$op_code, $uid)
    {
        global $DB;
    ...
    * @return integer
    */
    public function GetLastGiftByUid($uid)
    {
        global $DB;
 ...
 *
	 ...
	 */
	public function SetGiftResv($gid, $uid)
	{
	    global $DB;
 ...
 *
	...
	public function GetOrderInfo($bill_id, $uid)
	{
	    ...
	    if ($ammount < 0) {
	        $out = 'Перевод для <a href="/users/'.$login.'" class="blue">'.$uname.' '.$usurname.' ['.$login.']</a>';
	    } else {
	        $out = 'Перевод от <a href="/users/'.$login.'" class="blue">'.$uname.' '.$usurname.' ['.$login.']</a>';
	    }
 ...
 *
	 ...
	 */
	public function BlockedByOpId($uid, $opid)
	{
 ...
 *
	 * @return string Сообщение об ошибке
	 */
	public function unBlockedByOpId($uid, $opid)
	{
 ...
 *
    ...
    public function insertGift($insert)
    {
        global $DB;
