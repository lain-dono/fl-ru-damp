...
class messages_spam extends admin_parent
{
     ...
     */
    public function __construct($items_pp = 0)
    {
     ...
     */
    public function addSpamComplaint($sSpamerId = '', $sUserId = '', $aParams = array())
    {
     ...
     * @return bool true - успех, false - провал
     */
    public function deleteSpamBySpamer($aSpamerId = array(), $nResolve = 0)
    {
        $bRet = false;
     ...
     * @return bool true - успех, false - провал
     */
    public function deleteSpamByMsg($nSpamerId = 0, $sMsgMd5 = '', $nResolve = 0)
    {
        $bRet = false;
     ...
     * @return array
     */
    public function getComplaintsByUser($sUid = '')
    {
        $DB = new DB(); // plproxy
     ...
     * @return array
     */
    public function getSpamComplaints($nSpamerId = 0, $sMsgMd5 = '')
    {
        $DB = new DB(); // plproxy
     ...
     * @return array
     */
    public function getSpam(&$count, $filter, $page = 1)
    {
        $this->filter = $filter;
     ...
     * @return int
     */
    public function getSpamCount($filter = array())
    {
        $DB = new DB(); // plproxy
        $aFilter = array();
        $oMemBuf = new memBuff();
     ...
     * @return array
     */
    public function _getSpam(&$count, $page = 1, $order = 'general', $direction = 0, $unlimited = false)
    {
        $DB = new DB(); // plproxy
        $aFilter = array();
        $this->aSQL = array();
     ...
     * @param int    $direction порядок сортировки: 0 - по убыванию, не 0 - по возрастанию
     */
    public function _setSpamOrderBy($order = 'general', $direction = 0)
    {
     ...
     * @return array
     */
    public function getDatePeriod(&$error, $prefix = '', $fromD = '', $fromM = '', $fromY = '', $toD = '', $toM = '', $toY = '')
    {
        $aRet = array();
        $error = '';
