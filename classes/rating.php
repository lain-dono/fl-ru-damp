...
class rating
{
   ...
   */
  public function __construct($user_id = NULL, $is_pro = 'f', $is_verify = 'f', $is_profi = 'f', $fill_pos = TRUE, $fill_max = TRUE, $is_emp = 0)
  {
   ...
   */
  public function init($user_id, $is_pro = 'f', $is_emp = 0, $is_verify = 'f', $is_profi = 'f')
  {
      if (!$user_id) {
          return FALSE;
      }
   ...
   */
  public function GetByFormula($rating, $is_pro, $is_verify, $is_profi = 'f')
  {
      global $DB;
   ...
   */
  public function GetPredictionPRO($uid, $is_pro = 'f', $is_verify = 'f')
  {
      global $DB;
   ...
   */
  public function GetWorkFactorPlusIfPro($user_id)
  {
      global $DB;
      $sql = 
   ...
   */
  public function get_pos_by_specs($specs)
  {
      if (!$specs) {
          return NULL;
      }
   ...
   */
  public function get_max_of($prm = 'total', $is_emp = 0)
  {
      global $DB;
   ...
   */
  public function CountByRank($rank)
  {
      global $DB;
      $sql = "SELECT COUNT(*)
                FROM rating r
   ...
   */
  public function GetByRank($rank, $limit = 0, $offset = 0)
  {
      global $DB;
      $sql = 
   ...
   */
  public function Update($user_id, $fv)
  {
   ...
   */
  public function writeLog($name, $sql, $message)
  {
      $log_file = $this->log_file;
      if (!$log_file) {
          $log_file = $_SERVER['DOCUMENT_ROOT'].'/stat_collector/logs/rating.log';
      }
  ...
  public function setLogFile($file)
  {
     ...
     */
    public function getRatingByMonth($user_id, $date)
    {
        global $DB;
     ...
     */
    public function getRatingByYear($user_id, $year)
    {
        global $DB;
   ...
   * @return <type>
   */
  public function getMonthParts($date)
  {
      $ts = strtotime($date);
     ...
     * @param string $user
     */
    public function getRatingLog($user = false, $filter = false, $limit = 40, $page = 1, &$count = 0)
    {
        global $DB;
     ...
     */
    public function getBitFactors($str)
    {
        $position = array();
     ...
     */
    public function GetVerifyDate($user_id)
    {
        global $DB;
        $uer_id = (int) $user_id;
