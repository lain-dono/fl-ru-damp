...
class banner_promo
{
     ...
     **/
    public function setType($type = NULL, $nocache = false)
    {
        global $DB;        
        if (!$type) {
            $sql = "
     ...
     */
    public function writeClickStat()
    {
        global $DB;
        $date = date('Y-m-d');
     ...
     * @return boolean
     */
    public function saveInfoBanner($id, $name, $from_date, $to_date, $location, $is_activity, $name_img, $img_style, $img_title, $banner_link, $link_style, $advertising, $text, $type_ban = 'image', $code_txt = '', $login_access = '', $is_pro = '11', $is_role = '11', $page_target = '0|0')
    {
        global $DB;
     ...
     * @return boolean
     */
    public function createBanner($name, $from_date, $to_date, $location, $is_activity, $name_img, $img_style, $img_title, $banner_link, $link_style, $advertising, $text, $type_ban = 'image', $code_txt = '', $login_access = '', $is_pro = '11', $is_role = '11', $page_target = '0|0')
    {
        global $DB;
