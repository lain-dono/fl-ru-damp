...
class admin_parent
{
     ...
     * @return array
     */
    public function getIpRange(&$error, $fromIp = '', $toIp = '')
    {
        $aRet = array();
        $error = '';
     ...
     */
    public function validIp($ip, $errMsg)
    {
        if (trim($ip)) {
     ...
     * @return string
     */
    public function getIp($sIp, $sReplace = '0')
    {
        $ip = '';
     ...
     * @return bool
     */
    public function isAllowed($permission,  $user_permissions)
    {
