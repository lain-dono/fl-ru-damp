 ...
 *
	 * @return string
	 */
  public function GenBillNum($bank_code, $user_id, $account_id = NULL)
  {
   ...
   * @return array
   */
  public function GetLastReqv($bank_code, $user_id, $op_code = NULL)
  {
      global $DB;
 ...
 *
	 ...
	 */
	public function GetOrders($fdate, $tdate, $search = NULL, $sort)
	{
 ...
 *
	 ...
	 */
	public function Add(&$sError, $bReturnId = false)
	{
	    global $DB;
