...
class LZMA_SWF
{
     ...
     * @param int $length Количество ячеек памяти
     *
     ...
     * @param int   $offset С какой ячейки памяти читать
     * @param int   $length Количество ячеек памяти
     *
     * @return int
     */
     ...
     * 
     * @param int $size Размер несжатого SWF
     *
     * @return array
     */
     ...
     * 
     * @param string $filename Путь к файлу
     * @param bool   $header   Взять только заголовок файла
     *
     * @return array
     *
     * @throws Exception
