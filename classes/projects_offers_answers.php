 ...
 */
     ...
     *
     * @param int  $uid             - UID пользователя (0 - если нужно проверить того, кто авторизовался)
     * @param bool $freelancer_only - если false, то работодателям возвращает 0.
     *
     * return mixed - сообщение об ошибке или 0 в случае успеха
     */
    public function GetInfo($uid = 0, $freelancer_only = true)
    {
     ...
     * @param int $code - код покупки из таблицы projects_offers_op_codes
     *
     * @return mixed - сообщение об ошибке или 0 в случае успеха
     */
    public function BuyByFM($uid, $ammount, $tr_id = 0, $commit = 1)
    {
        $uid = intval($uid);
        //if ($ammount == 1) {
     ...
     *
     * @param int $uid     - UID пользователя
     * @param int $ammount - кол-во ответов
     *
     * return boolean
     */
    public function AddPayAnswers($uid, $ammount = 1)
    {
     ...
     * return boolean
     */
    public function DelPayAnswers($uid, $ammount = 1)
    {
     ...
     *
     * @param int $ammount - кол-во купленных ответов
     *
     * return string
     */
    public function ShowDoneInfo($ammount)
    {
        $ammount = intval($ammount);
