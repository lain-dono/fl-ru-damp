...
class QChat
{
     ...
     * 
     * @param int  $evid - id события которое нужно послать
     * @param bool $one  - если false, то посылаются все события от $evid до текущего; если true - только $evid
     */
     ...
     *
     * @return bool если true - все выключаем, все сломалось :), если false - обычная ошибка
     */
