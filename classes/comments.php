...
class comments
{
     ...
     *
     * @param int   $count  Возвращает общее количество комментариев
     ...
     * @param int   $limit  Количество сообщений, которые нужно отобразить
     * @param int   $offset С какого сообщения отображать
     *
     ...
     * @param int    $type       Тип группы комментариев
     * @param int    $id         id комментария
     * @param int    $user_id    uid пользователя, комментарий которого редактируем
     * @param int    $moder_uid  uid пользователя, который редактирует
