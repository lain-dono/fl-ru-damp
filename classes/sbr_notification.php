...
class sbr_notification
{
     ...
     * @param bool   $role           Роль (true - заказчик, false - исполнитель) @see sbr::isEmp();
     ...
     * 
     * @param int     $sbr_id ИД СБР
     * @param int     $own_id ИД записи @see таблица sbr_events
     ...
     * @param int     $stage_id ИД Этапа Сбр
     *
    ...
    public static function getNotificationName($abbr, $type, $stages)
    {
