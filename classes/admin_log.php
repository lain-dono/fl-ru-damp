...
class admin_log extends admin_parent
{
     ...
     * @var array
     */
    public static $aObjInactive = array(self::OBJ_CODE_OFFER, self::OBJ_CODE_PMSG);
     ...
     * @var array
     */
    public static $mode_allow = array('log', 'user', 'proj', 7 => 'stat', 'notice', 'offer');
     ...
     * @var array
     */
    public static $mode_permissions = array('log' => 'adm', 'user' => 'users', 'proj' => 'projects', 'stat' => 'all', 'notice' => 'adm', 'offer' => 'projects');
     ...
     * @var array
     */
    public static $mode_code = array('log' => 0, 'user' => self::OBJ_CODE_USER, 'proj' => self::OBJ_CODE_PROJ, 'stat' => 0);
     ...
     */
    public function __construct($mode = 'log', $uid = 0, $user_permissions = array())
    {
        $this->mode = $mode;
        $this->curr_uid = $uid;
     ...
     */
    public function setLogPerPage($log_pp = 20)
    {
     ...
     * @return bool true - успех, false - провал
     */
    public function setAdminNoticeEmail($nAdminId = 0, $sEmail = '', &$sError)
    {
     ...
     * @return string
     */
    public function getAdminNoticeEmail($nAdminId = 0)
    {
     ...
     * @return bool true - успех, false - провал
     */
    public function setAdminNotices($nAdminId = 0, $aActions = array())
    {
        if (!intval($nAdminId)) {
            return false;
        }
     ...
     * @return array
     */
    public function getAdminNotices($nAdminId = 0)
    {
     ...
     * @return array
     */
    public function getProjBlock($sId = 0)
    {
     ...
     * @return array
     */
    public function getOfferBlock($sId = 0)
    {
     ...
     * @return array
     */
    public function getUserWarn($sId = 0)
    {
     ...
     * @return bool true - успех, false - провал
     */
    public function updateLog($sId = 0, $sReason, $sReasonId = null, $sUid = 0)
    {
        if (!$sUid) {
     ...
     * @return bool true - успех, false - провал
     */
    public function updateProjBlock($sId = 0, $sReason, $sReasonId = null, $sUid = 0)
    {
        if (!$sUid) {
            if (!($sUid = $_SESSION['uid'])) {
                return false;
     ...
     * @return bool true - успех, false - провал
     */
    public function updateOfferBlock($sId = 0, $sReason, $sReasonId = null, $sUid = 0)
    {
        if (!$sUid) {
            if (!($sUid = $_SESSION['uid'])) {
                return false;
     ...
     * @return bool true - успех, false - провал
     */
    public function updateUserWarn($sId = 0, $sReason, $sReasonId = null, $sUid = 0)
    {
        if (!$sUid) {
            if (!($sUid = $_SESSION['uid'])) {
                return false;
     ...
     * @return array
     */
    public function getAdminActions($objCode = 0)
    {
        $sRights = '';
        $sInactive = '';
     ...
     * @return array
     */
    public function getPermissionsRights()
    {
        $rights = array();
     ...
     * @return array
     */
    public function getAdminsInLog($objCode = 0)
    {
        $sJoin = $sWhere = '';
        ...
        return $GLOBALS['DB']->rows("SELECT u.uid, u.login FROM users u 
            ...
            ORDER BY u.login", self::ACT_ID_DEL_ACC);
    }
     ...
     * @return bool true - успех, false - провал
     */
    public function setLogCLV($userId = 0, $logId = 0)
    {
     ...
     */
    public function getUserToLogInfo($userId = 0, $logId = 0)
    {
     ...
     * @return array
     */
    public function getHiddenThreads($userId = 0, $logId = 0)
    {
     ...
     * @return array
     */
    public function getLogById($logId = 0)
    {
     ...
     * @return array
     */
    public function getLogAll(&$count, $filter, $page = 1)
    {
        $this->filter = $filter;
     ...
     * @return array
     */
    public function getLogProjById(&$count, $sPrjId)
    {
     ...
     * @return array
     */
    public function getLogOfferById(&$count, $sOfferId)
    {
     ...
     * @return array
     */
    public function getLogUserById(&$count, $sUserId, $sActId = '')
    {
     ...
     * @return array
     */
    public function getLogProj(&$count, $filter, $page = 1, $order = 'date', $direction = 'desc')
    {
     ...
     * @return array
     */
    public function getLogOffer(&$count, $filter, $page = 1, $order = 'date', $direction = 'desc')
    {
     ...
     * @return array
     */
    public function getLogUser(&$count, $filter, $page = 1, $order = 'date', $direction = 'desc')
    {
     ...
     * @return array
     */
    public function getUserWarns(&$count, $sUid)
    {
     ...
     * @return array
     */
    public function getLogCounts($sObjCode = 0, $sObjId = 0)
    {
     ...
     * @return array
     */
    public function getLog(&$count, $page = 1, $order = 'general', $direction = 0, $unlimited = false)
    {
        $this->aSQL = array();
...
//echo $GLOBALS['DB']->parse( $sQuery );
     ...
     * @param int    $direction порядок сортировки: 0 - по убыванию, не 0 - по возрастанию
     */
    public function _setLogOrderBy($order = 'general', $direction = 0)
    {
     ...
     *
     * @param int $reasonId ID действя админа.
     *
     * @return string полный текст причины действя админа.
     */
    public function getAdminReasonText($reasonId)
    {
     ...
     * @return array
     */
    public function getAdminReasons($nActId = 0, $bSortBold = true)
    {
     ...
     * @return bool true - успех, false - провал
     */
    public function addAdminReason($act_id = 0, $reason_name = '', $reason_text = '', $is_bold = 'f')
    {
     ...
     *
     * @param int $reasonId ID причины действя админа.
     *
     * @return arrary
     */
    public function getAdminReason($reasonId)
    {
     ...
     * @return bool true - успех, false - провал
     */
    public function updateAdminReason($id = 0, $reason_name = '', $reason_text = '', $is_bold = 'f')
    {
     ...
     * @return bool true - успех, false - провал
     */
    public function setReasonBold($id = 0, $is_bold = 'f')
    {
     ...
     * @return bool true - успех, false - провал
     */
    public function deleteAdminReason($id = 0)
    {
     ...
     * @return bool true - успех, false - провал
     */
    public function addLog($object_code, $act_id, $user_id, $object_id, $object_name, $object_link, $context_code, $context_link, $reason_id, $admin_comment, $src_id = null, $context_name = '', $admin_id = 0)
    {
     ...
     */
    public function GetNotices4Sending($log_ids, $connect = null)
    {
        $aRet = array();
     ...
     * @return array
     */
    public function getStatByAdmin($nUserId = 0)
    {
        // если не админ - то показывать только те действия на которые юзер имеет права
        if (!in_array('all', $this->user_permissions)) {
     ...
     * @return array
     */
    public function getAllStat($filter = array(), $order = 'general', $direction = 1)
    {
        $this->filter = $filter;
        $this->aSQL = array();
...
//echo $GLOBALS['DB']->parse( $sQuery );
     ...
     */
    public function _setAllStatSelect()
    {
     ...
     */
    public function _setAllStatJoin()
    {
     ...
     * @param int    $direction порядок сортировки: 0 - по убыванию, не 0 - по возрастанию
     */
    public function _setAllStatOrderBy($order = 'general', $direction)
    {
        $dirSql = (!$direction ? 'DESC' : 'ASC');
     ...
     * @return array
     */
    public function getGrafikStat($filter = array())
    {
        $this->filter = $filter;
        $this->aSQL = array();
...
//echo $GLOBALS['DB']->parse( $sQuery );
     ...
     */
    public function _setGrafikSelectI()
    {
     ...
     */
    public function _setGrafikSelectO()
    {
     ...
     * @param int $direction порядок сортировки: 0 - по убыванию, не 0 - по возрастанию
     */
    public function printReportAll($actions = array(), $filter = array(), $order = 'general', $direction = 1)
    {
        $sCurrDate = date('Y-m-d');
     ...
     * @param array  $filter        фильтр
     */
    public function printReport($sAdminName = '', $sAdminSurname = '', $filter = array())
    {
        // имя итогового файла
        ...
        if ($log) {
            ...
            foreach ($log as $aOne) {
                ...
                $worksheet->write($nCnt + 3, 0, $aOne['act_name'].' '.self::$aObj[$aOne['obj_code']]['short'], $format_td);
     ...
     * @return array
     */
    public function getDatePeriod(&$error, $fromD = '', $fromM = '', $fromY = '', $toD = '', $toM = '', $toY = '')
    {
        $aRet = array();
        $error = '';
     ...
     */
    public function checkTimePeriod(&$bIsNull, $fromH = '', $fromI = '', $toH = '', $toI = '')
    {
        $bIsNull = false;
        $sError = '';
     ...
     * @return array
     */
    public function getTimePeriod($sTimePeriod, &$div)
    {
