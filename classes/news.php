 ...
 *
	 ...
	 */
	public function GetNews($date, &$error)
	{
	    global $DB;
 ...
 *
	 ...
	 */
	public function GetNewsById($id, &$error)
	{
	    global $DB;
 ...
 *
	 ...
	 */
	public function GetAllNews(&$error)
	{
	    global $DB;
 ...
 *
	 ...
	 */
	public function Add($post_date, $header, $n_text)
	{
	    global $DB;
 ...
 *
	 * @return string Сообщение об ошибке
	 */
	public function Edit($post_date, $header, $n_text, $id)
	{
	    global $DB;
	    $data = compact('post_date', 'header', 'n_text');
