            ...
            if ($action != 'create_project' && $existPrjID) {
                ...
                if ($option['top'] == 1 && $option['top_count'] > 0) {
                    ...
                    $pay_option[] = array(
                        ...
                        'option' => self::PROJECT_OPTION_TOP, // Закрепление проекта
                        'type' => $data['kind'] == 7 ? self::BILL_TYPE_CONTEST : self::BILL_TYPE_PROJECT,
                        'ammount' => $price,
                    );
                } else {
                    $data['top_count'] = 0;
                ...
                if ($option['color'] == 1) {
                    ...
                    $pay_option[] = array(
                        'wiz_uid' => $this->getWizardUserID(),
                        'op_code' => new_projects::OPCODE_PAYED,
                        'option' => self::PROJECT_OPTION_COLOR, // Выделение цветом 
                        'type' => $data['kind'] == 7 ? self::BILL_TYPE_CONTEST : self::BILL_TYPE_PROJECT,
                        'ammount' => $colorPrc,
                    );
                } else {
                ...
                if ($option['bold'] == 1) {
                    ...
                    $pay_option[] = array(
                        'wiz_uid' => $this->getWizardUserID(),
                        'op_code' => new_projects::OPCODE_PAYED,
                        'option' => self::PROJECT_OPTION_BOLD, // Выделение текста
                        'type' => $data['kind'] == 7 ? self::BILL_TYPE_CONTEST : self::BILL_TYPE_PROJECT,
                        'ammount' => $boldPrc,
                    );
                } else {
                ...
                if ($option['logo'] == 1) {
                    ...
                    $pay_option[] = array(
                        'wiz_uid' => $this->getWizardUserID(),
                        'op_code' => new_projects::OPCODE_PAYED,
                        'option' => self::PROJECT_OPTION_LOGO, // Логтип
                        'type' => $data['kind'] == 7 ? self::BILL_TYPE_CONTEST : self::BILL_TYPE_PROJECT,
                        'ammount' => $logoPrc,
                    );
                }
