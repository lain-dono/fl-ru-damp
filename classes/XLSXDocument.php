...
//            $this->initDOMDocument('style',  $this->_styleIndex);
     ...
     *
     * @return int Номер позиции сгенерированного элемента
     */
     ...
     * 
     * @param int    $index Индекс текста (позиция элемента)
     ...
     * 
     * @param int $new_position Позиция строки которую вставили
     */
     ...
     * @param int    $index Индекс документа в архиве 
     *
     * @return type
     */
