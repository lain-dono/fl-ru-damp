...
class pf
{
    ...
    {
        global $DB;
        if (empty($this->post_data) || $this->isError()) {
            return false;
        }
     ...
     * @param string $from_date С даты
     * @param string $to_date   По дату
     * @param bool   $bYear     За определенный год
     * @param bool   $bYearAll  За все года
     *
     * @return array
     */
