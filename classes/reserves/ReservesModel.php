...
class ReservesModel extends BaseModel
{
    ...
    public static $_TABLE = 'reserves';
    public static $_TABLE_META = 'reserves_meta';
    public static $_TABLE_SRC;
    public static $_TABLE_EMPLOYER = 'employer';
     ...
     *
     * @return bool | array - вернуть данные для добавления
     */
    ...
    public function getReservesBank($options = array())
    {
        ...
        if (!$this->reserves_bank) {
            $this->reserves_bank = $class::model($options);
        }
