...
class splash_screens
{
     ...
     * @return bool
     */
    public function show($type, $debug = false, $setViewed = true)
    {
        $need_show = false;
     ...
     */
    public function checkContactsSplashShow()
    {
        require_once $_SERVER['DOCUMENT_ROOT'].'/classes/users.php';
        $users = new users();
     ...
     */
    public function checkEmpFrlSplashShow($splashType)
    {
     ...
     */
    public function getSplashLastDate()
    {
        require_once $_SERVER['DOCUMENT_ROOT'].'/classes/users.php';
        $users = new users();
     ...
     *
     * @param int $unixTime в формате UnixTime
     */
    public function saveSplashLastDate($unixTime)
    {
    ...
    public function isViewed($type)
    {
        return $_SESSION['splash_show'] & $type;
    }

    public function setViewed($type)
    {
        $users = new users();
        $splash_show = $users->GetField(get_uid(), $error, 'splash_show');
    ...
    public function getTemplateSplash($type)
    {
        switch ($type) {
