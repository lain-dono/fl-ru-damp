...
class wm_payments
{
     ...
     */
    public function pay($name, $passport_serie, $passport_number, $passport_date, $purse, $price, $cheque, $kiosk_id, $phone)
    {
        $this->_initWMXI();
        $this->_pdata = compact(
     ...
     * Не пашет.
     */
    public function history($from_date, $to_date, $test = null)
    {
        $this->_initWMXI();
     ...
     * @return bool false
     */
    public function error($err, $encoding = null)
    {
