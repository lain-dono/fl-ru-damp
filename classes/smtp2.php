...
class smtp2 extends SMTP
{
     ...
     * 
     * @param int $spamid id письма для которой добавляем адресатов
     *
     * @return int id письма (0 - ошибка) 
     */
    public function bind($spamid)
    {
        ...
        } elseif (is_string($this->recipient) && $this->recipient != '') {
     ...
     *
     * @return bool TRUE если соединение создано; FALSE если нет
     */
     ...
     *
     * @return bool TRUE если соединение установлено; FALSE если установить соединение не удалось
     */
     ...
     *
     * @return int код ответа SMTP сервера
     */
