...
class projects_offers
{
     ...
     */
    public function AddOffer($user_id, $prj_id, $cost_from, $cost_to, $cost_type, $time_from, $time_to, $time_type, $text,
     ...
     * @return $error Ошибка;
     */
    public function setFieldsOffers($id_offer, $fields = array())
    {
        global $DB;
     ...
     * @return string текст ошибки в случае неуспеха
     */
    public function AddOfferKon($user_id, $prj_id, $text, $work_pict, $work_prev_pict, $for_customer_only = false)
    {
        global $DB; 
        $obj_portfolio = new portfolio();
        $obj_dialogue = new projects_offers_dialogue();
     ...
     */
    public function DelOffer($offer_id, $prj_id, $user_id, $force = false)
    {
        global $DB; 
     ...
     */
    public function DelOfferNotification($offer_id = 0, $deluser_id = 0)
    {
     ...
     */
    public function GetPrjOffer($prj_id, $user_id)
    {
        global $DB;
        $ret = false;
     ...
     */
    public function getSbrExecData($sbrID)
    {
        global $DB;
        if (!$sbrID) {
            return false;
     ...
     * @return array данные предложения
     */
    public function GetPrjOfferById($offer_id = 0)
    {
        $ret = false;
        $sql = 'SELECT po.*,
     ...
     */
    public function Blocked($offer_id = 0, $user_id = 0, $project_id = 0, $reason, $reason_id = null, $uid = 0, $from_stream = false)
    {
        global $DB;
     ...
     */
    public function UnBlocked($offer_id)
    {
        global $DB;
     ...
     */
    public function IsPrjOfferExists($prj_id, $user_id)
    {
        global $DB;
        $ret = false;
        if ($user_id > 0) {
     ...
     */
    public function CountPrjOffers($pid, $type = 'offers')
    {
        global $DB;
     ...
     */
    public function GetFrlOffersSummary($fid)
    {
        global $DB;
     ...
     */
    public function WasteProj($offer_id, $user_id)
    {
        global $DB;
     ...
     */
    public function GetFrlOffersWaste($fid)
    {
        global $DB;
        $sql = 
      "SELECT 
     ...
     * @return mixed массив данных или NULL в случае ошибки
     */
    public function GetFrlOffers($fid, $mode = 'marked', $from_date = NULL, $limit = 'ALL')
    {
        global $DB;
     ...
     */
    public function OfferExist($prj_id, $user_id)
    {
        global $DB;
     ...
     * @return string сообщение об ошибке
     */
    public function SetSelected($po_id, $prj_id, $user_id, $selected = true)
    {
        global $DB;
        $po_id = intval($po_id);
        $prj_id = intval($prj_id);
     ...
     */
    public function CheckOffers($frl_id)
    {
        global $DB;
        $frl_id = (int) $frl_id;
     ...
     * @return bool
     */
    public function IsExistOffer($frl_id, $project_id)
    {
        global $DB;
     ...
     * @return array()
     */
    public function AllFrlOfferProjectIDs($frl_id)
    {
        global $DB;
     ...
     * @return type
     */
    public function AllFrlOffersByProjectIDs($project_ids = array())
    {
        global $DB;
     ...
     */
    public function CountOffersForEmp($user_id, $new = false)
    {
        global $DB;
        $user_id = intval($user_id);
     ...
     * @return type
     */
    public function CountNewPrjEventsForEmp($user_id)
    {
        $mem = new memBuff();
     ...
     */  
    public function CheckNewEmpEvents($user_id)
    {
        global $DB;
     ...
     */    
    public function CheckNewFrlEvents($user_id, $waste = true)
    {
        global $DB;
     ...
     */
    public function getNewProjectOffers($offer_ids, $connect = NULL)
    {
        global $DB;
        if (!$offer_ids) {
            return NULL;
     ...
     * @return array|mixed Если есть ответы к проектам то возвращает массив их, если нет то NULL
     */
    public function getNewPrjMessageOnOffer($dialog_ids, $connect = NULL)
    {
        global $DB;
        if (!$dialog_ids) {
            return NULL;
     ...
     * @return array|mixed Если есть ответы к проектам то возвращает массив их, если нет то NULL
     */
    public function getRefusedProjectOffers($offer_ids, $connect = NULL)
    {
        global $DB;
        if (!$offer_ids) {
            return NULL;
     ...
     * @return array|mixed Если есть ответы к проектам то возвращает массив их, если нет то NULL
     */
    public function getSelectedProjectOffers($offer_ids, $connect = NULL)
    {
        global $DB;
        if (!$offer_ids) {
            return NULL;
     ...
     */
	public function OffersEmpNewMessages($prj_id)
	{
	    global $DB;
     ...
     * @return integer
     */
    public function getProjectIDByOfferID($offer_id)
    {
        global $DB;
     ...
     * @return type
     */
    public function getOfferIDByProjectID($project_id, $user_id)
    {
        global $DB;
     ...
     */
    public function isOfferBlocked($offer_id, $frl_id = null, $prj_id = null)
    {
        $prj_id = (int) $prj_id;
        $frl_id = (int) $frl_id;
