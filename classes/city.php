...
class city
{
    protected static $_data_cache = array();
     ...
     */
    public function getCityIDByTranslit($translit, &$country_id = 0)
    {
        global $DB;
        if ($country_id == 0) {
     ...
     */
    public function GetCountryName($cityId)
    {
        global $DB;
     ...
     */
    public function getCityIdByCountry($name, $country_id)
    {
