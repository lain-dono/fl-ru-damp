...
class sms_gate
{
     ...
     * @param bool   $revert Обратная кодировка
     *
     * @return string
     */
     ...
     * @return bool
     */
    public function sendAuthCellCode($type = self::TYPE_ACTIVATE)
    {
     ...
     * @param bool $auth флаг активации 
     *
     * @return bool
     */
     ...
     * @param int    $sms_id  Идентификатор сообщения в системе Пластик, на который отправляется ответ (если null то сообщение не ответное а новое)
     *
     * @return bool
     */
     ...
     */
    public static function saveSmsInfo($phone, $isnn, $data, $date_send, $uid)
    {
        global $DB;
