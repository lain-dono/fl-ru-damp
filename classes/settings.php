 ...
 *
	 * @return string
	 */
	public function GetVariable($module, $variable)
	{
	    global $DB;
 ...
 *
	 * @return string
	 */
	public function SetVariable($module, $variable, $value)
	{
	    global $DB;
         ...
         * @return type
         */
        public function AddVariable($module, $variable, $value)
        {
            global $DB;
            ...
            if ($is_exist > 0) {
                return $DB->update('settings', array('value' => $value), 'id = ?i', $is_exist);
            }
