...
class gray_ip extends admin_parent
{
     ...
     * @return array
     */
    public function getPrimaryIpByUid($nUid = 0)
    {
     ...
     */
    public function addPrimaryIp($nUserId = 0, $sUserLogin = '', $nAdminId = 0, $aIp = array())
    {
        $bRet = true;
        $aData = array();
     ...
     * @return bool true - успех, false - провал
     */
    public function deletePrimaryIp($nUserId = 0, $aIp = array())
    {
        $bRet = true;
     ...
     * @return bool true - успех, false - провал
     */
    public function updatePrimaryIp($nUserId = 0, $sUserLogin = '', $nAdminId = 0, $aIp = array(), &$bDel)
    {
        $bRet = true;
        $bDel = false;
     ...
     * @return bool true - успех, false - провал
     */
    public function deletePrimaryUser($nUserId = 0)
    {
     ...
     * @return array
     */
    public function getGrayListByRegIp($sRegIp)
    {
     ...
     * @return bool true - успех, false - провал
     */
    public function addSecondaryIp($nUserId = 0, $sUserLogin = '', $sUserRole = '', $aPrimaryId = array())
    {
        $bRet = true;
     ...
     * @return bool true - успех, false - провал
     */
    public function deleteSecondaryIp($aSecondaryId = array())
    {
        $bRet = true;
     ...
     * @return bool true - успех, false - провал
     */
    public function deleteSecondaryIpByPrimary($aSecondaryId = 0)
    {
        $GLOBALS['DB']->query('DELETE FROM gray_ip_secondary WHERE user_id IN (?l)', $aSecondaryId);
     ...
     * @return array
     */
    public function getGrayIpList(&$count, $filter, $page = 1)
    {
        $this->filter = $filter;
     ...
     * @return array
     */
    public function getGrayIp(&$count, $page = 1, $order = 'general', $direction = 0, $unlimited = false)
    {
        $this->aSQL = array();
...
//echo $GLOBALS['DB']->parse( $sQuery );
     ...
     */
    public function _setOrderBy($order = 'general', $direction = 0)
    {
