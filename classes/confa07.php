 ...
 *
	 ...
	 */
    public function Update($name, $surname, $type, $mess, $uid)
    {
        if (self::CheckUid($uid)) {
 ...
 *
	 * @return array|boolan Информация выборки, либо false если нет информации
	 */
    public function GetAllUinfo($uid)
    {
