...
class traffic_stat extends admin_parent
{
     ...
     * @var array
     */
    public static $aProCode = array(1, 2, 3, 4, 5, 6, 15, 48, 49, 50, 51, 76);
     ...
     */
    public function calculateStatsIp()
    {
     ...
     * 
     * @param int  $type       Тип платной услуги (0 - логотип, 1 - фон, 2 - выделение текста, 3 - поднятие проекта)
     * @param bool $is_konkurs Берем данные по конкурсу или нет
     * @param bool $is_bonus   Берем данные по бонусам или нет
     *
     ...
     */
    public function checkRegistration($nUid = 0, $nRole = 0)
    {
        if ($this->aDomains) {
            foreach ($this->aDomains as $aOne) {
                $sCookie = 'traffic_stat_reg_'.$aOne['id'];
     ...
     */
    public function initDomainFromDB($sDomainId = 0)
    {
        $this->bDomainSet = false;
     ...
     * Инициализирует поля класса входящими параметрами и выполняет валидацию данных.
     */
    public function initFilterFromParams()
    {
     ...
     * @return string
     */
    public function getDomainIdError()
    {
     ...
     * @return string
     */
    public function getDomainNameError()
    {
     ...
     * @return int
     */
    public function getFilterDomainId()
    {
     ...
     * @return string
     */
    public function getDateFrom($sFormat = 'd.m.Y')
    {
     ...
     * @return string
     */
    public function getDateTo($sFormat = 'd.m.Y')
    {
     ...
     * @return string
     */
    public function getFilterErrorAlert()
    {
