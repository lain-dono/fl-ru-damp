...
class paid_advices
{
     ...
     * @param int            $author  от кого рекомендация (false - от всех, 1 - от фрилансеров, 2 - от работодателей)
     *
     * @return array
     */
     ...
     * 
     * @param int $id_advice ИД рекомендации
     *
     * @return int Статус рекомендации    
     */
