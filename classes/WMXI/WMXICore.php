...
if (file_exists(__DIR__.DIRECTORY_SEPARATOR.'WMSigner.php')) {
    include_once __DIR__.DIRECTORY_SEPARATOR.'WMSigner.php';
}
if (file_exists(__DIR__.DIRECTORY_SEPARATOR.'WMXIResult.php')) {
    include_once __DIR__.DIRECTORY_SEPARATOR.'WMXIResult.php';
}
...
class WMXICore
{
    ...
    {
        if (!$this->classic) {
            die('Classic initialization required to sign the string.');
        }
