 ...
 *
	 * @return array
	 */
    public function GetAllProfessionsPortf($user, $table = 'portf_choise')
    {
        global $DB;
        $sql = "
        SELECT DISTINCT
 ...
 *
	 * @return array 
	 */
	public function GetAllProfessionsPortfWithoutMirrored($user, $checked = '')
	{
	    global $DB;
	    $sql = "SELECT DISTINCT
                   p.id,
    ...
    * @return array
    */
    public function GetAllProfessionsSpec($user)
    {
        global $DB;
        $sql = "SELECT DISTINCT
               p.id,
     ...
     * @return array
     */
    public function GetAllProfessions($prof_group = '', $mod = 1, $orderByCount = 0, $nocache = false)
    {
        global $DB;
        static $professions;
 ...
 *
	 * @return array
	 */
    public function GetProfessionsByUser($user_id, $get_0 = TRUE, $mirr = false)
    {
        global $DB;
        $sql =
        'SELECT 
    ...
    public function getProfessionsByUser2($user_id, $mirr = false)
    {
        global $DB;
     ...
     * @return integer
     */
    public function ReCalcProfessionsCount()
    {
        global $DB;
    ...
    public function removePortfChoise($uid, $prof_id)
    {
        global $DB;
     ...
     * @return array
     */
    public function UpdatePortfChoise($fid, $profs)
    {
        global $DB;
        foreach ($profs as $val) {
            if (intval(trim($val)) != 0) {
                $params[] = intval(trim($val));
            }
        }
 ...
 *
	 * @return array
	 */
	public function GetProfTitle($id)
	{
     ...
     * @return array
     */
    public function GetProfGroupTitle($id)
    {
 ...
 *
	 * @return string
	 */
    public function GetProfName($id)
    {
	 ...
	 * @return string
	 */
    public function GetProfNameWP($id, $delimiter = '/', $default = 'Все разделы', $with_link = 'b-layout__link b-layout__link_fontsize_11 b-layout__link_color_80', $p_name = false, &$link = '')
    {
        global $DB;
        if ((int) $id < 1) {
            return $default;
 ...
 *
	 * @return array
	 */
    public function GetProfs($category_id)
    {
        global $DB;
 ...
 *
	 * @return string
	 */
    public function GetGroupNameWP($id)
    {
        global $DB;
        if ((int) $id < 1) {
            return false;
 ...
 *
	 * @return string
	 */
	public function GetProfField($id, $fieldname)
	{
...
/**
   ...
   * @return string
   */
  public function GetProfGEOField($id, $fieldname, $country_id, $city_id)
  {
 ...
 *
	 * @return string
	 */
	public function GetProfGroupName($id)
	{
 ...
 *
	 ...
	 */
	public function GetProfType($id)
	{
 ...
 *
	 ...
	 */
	public function GetProfId($link)
	{
     ...
     */
    public function GetProfGroupId($link)
    {
     ...
     * @return integer id группы или 0, если группа не найдена
     */
    public function GetProfGroupParentId($link)
    {
 ...
 *
   ...
   */
  public function GetGEOGroups($country = 0, $city = 0)
  {
      global $DB;
 ...
 *
	 * @return array
	 */
  public function GetAllGroupsLite($only_active = FALSE, $idkey = false)
  {
      global $DB;
      $sql = '
 ...
 *
	 * @return array
	 */
	public function GetGroup($id, &$error)
	{
 ...
 *
	 * @return array
	 */
	public function GetSpecs($login)
	{
	    return $GLOBALS['DB']->rows('
 ...
 *
	 * @return array
	 */
	public function GetSelProf($fid)
	{
 ...
 *
	 ...
	 */
	public function GetSelFilProf($fid, $onlyWithPreview = false)
	{
     ...
     * @return array
     */
    public function GetProfDesc($fid = 0, $prof_id = 0)
    {
    ...
    */
    public function UpdateProfDesc($fid, $prof_id, $cost_from, $cost_to, $cost_hour, $cost_1000, $cost_type, $cost_type_hour, $time_type, $time_from, $time_to, $text, &$errorProfText, $moduser_id = null, $modified_reason = '')
    {
        global $DB;
        $id = intval($fid);
    ...
    public function prepareCostText($prof, $stop_words = null)
    {
        ...
        $prof['is_pro_profession'] = ($prof['prof_id'] == self::BEST_PROF_ID || $prof['prof_id'] == self::CLIENTS_PROF_ID);
     ...
     */
	public function UpdateSpecDesc($fid, $prof_ids, $prises, $times)
	{
	    global $DB;
	    $i = 0;
	    if ($prof_ids) {
 ...
 *
     ...
     * @return string Сообщение об ошибке если есть
     */
	public function EditGroup($id, $name = NULL, $nameCase = NULL)
	{
	    global $DB;
	    $uptext = '';
	    if (!is_null($name)) {
 ...
 *
	 * @return string Сообщение об ошибке если есть
	 */
	public function PosGroupChange($pos)
	{
	    global $DB;
	    $DB->clear();
	 ...
	 * @return string Сообщение об ошибке если есть
	 */
    public function NewProf($name, $porfgr, &$out = NULL, $keywords = NULL)
    {
        global $DB;
        $link = translit($name);
     ...
     * @return string Сообщение об ошибке если есть
     */
    public function EditProf($id, $name = NULL, $descr = NULL, $istext = 'true', $title = NULL, $descr_text = NULL, $keywords = NULL, $use_geo = false, $country = 0, $city = 0, $name_case = null, $header_about = null, $header_list = null, $descr_text2 = null)
    {
        global $DB;
        if ($name === NULL && $descr === NULL && $descr_text === NULL) {
            return 0;
        }
        if ($country) {
 ...
 *
	 * @return string  Сообщение об ошибке если есть
	 */
	public function PosProfChange($pos)
	{
	    global $DB;
	    $DB->clear();
 ...
 *
	 * @return array
	 */
	public function GetMirroredProfs($profid)
	{
	    global $DB;
	    if (!$profid || $profid === '') {
	        return array(0);
	 ...
	 */
	public function GetProfessionOrigin($profid)
	{
	    global $DB;
	    if (!is_array($profid)) {
	        $profid = explode(',', $profid);
	 ...
	 * @return array
	 */
    public function GetAllMirroredProfsId()
    {
 ...
 *
	 * @return array
	 */
	public function GetProfessions($profs)
	{
	    global $DB;
	    if ($profs) {
 ...
 *
	 ...
	 */
	public function GetChangeProfNames($old_prof_id, $new_prof_id)
	{
 ...
 *
	 * @return boolean 
	 */
    public function UpdateProfsAddSpec($user_id, $oldprof_id, $prof_id, $paid_id)
    {
        global $DB;
        $nprof_id = 'NULL';
        $prof_orig = 'NULL';
     ...
     */
    public function downSpec($uid, $paid_id, $prof_id, &$mode)
    {
        global $DB;
        ...
        if ($paid_id) {
            if ($pr == $max_pr) {
                return false;
            } // двигается вниз платная с последней позиции
     ...
     * @return bool true - успех, false - провал
     */
    public function moveSpec($uid, $paid_id, $prof_id, $dir, &$new_paid_id = null)
    {
        global $DB;
        if ($paid_id) {
            $sql = $DB->parse('
     ...
     */
    public function setSpecAutoPay($uid, $paid_id)
    {
        global $DB;
     ...
     * @return array
     */
    public function GetProfsAddSpec($user_id)
    {
        global $DB;
 ...
 *
	 * @return string Сообщение об ошибке если есть
	 */
	public function UpdateProfessionCount($prof, $count, $pro_count)
	{
	    global $DB;
	    $mirrored = self::GetMirroredProfs($prof);
    ...
    */
    public function GetCatalogPosition($user_id, $user_spec, $rating, $prof_id, $is_pro, $not_exact = false)
    {
        global $DB;
        ...
        if (!$prof_id) {
            ...
            if (!$not_exact) {
                $pos_table = self::GetCatalogPositionsTable();
        ...
        $or_prof = $prof_id;
        $or_prof = self::GetProfessionOrigin($prof_id);
 ...
 *
	 * @return string Сообщение об ошибке если есть
	 */
    public function EditProfText($id, $descr = NULL)
    {
        global $DB;
        if ($descr === NULL) {
            return 0;
 ...
 *
  	 ...
  	 */
  	public function getProfIdForGroups($group, $orig = false)
  	{
  	    global $DB;
  	    if (is_array($group)) {
  	    ...
  	    if ($orig && $ids) {
  	        return self::GetProfessionOrigin(implode(', ', $ids));
  	    }
     ...
     */
    public function buySpec($uid, $ammount, $tr_id = 0, $period = '1 mon', $commit = 1)
    {
        global $DB;
     ...
     * @return string Сообщение об ошибке если есть
     */
    public function prolongSpecs($uid, $is_autopaid = false, $period = '1 mon', $prolong_only = false)
    {
        global $DB;
     ...
     */
    public function autoProlongSpecs($period = '1 mon')
    {
        global $DB;
     ...
     * @return array
     */
    public function deleteExpiredSpecs()
    {
     ...
     */
    public function getPaidSpecs($uid, $only_def = false, $is_autopaid = false, $prolong_only = false)
    {
        global $DB;
        $where = "WHERE s.user_id = {$uid} AND s.paid_to >= now()";
        if ($only_def) {
            $where .= ' AND prof_id IS NOT NULL';
        }
        if ($is_autopaid) {
            $where .= ' AND is_autopaid = true';
        }
        if ($prolong_only) {
            $where .= " AND (paid_to BETWEEN now() AND now() + interval '2 hours')";
        }
        $sql = "
     ...
     * @return array
     */
    public function getAddSpecs($uid)
    {
        global $DB;
        $sql = '
     ...
     * 
     */
    public function PaidSpecsEndingReminder()
    {
        global $DB;
        require_once $_SERVER['DOCUMENT_ROOT'].'/classes/smail.php';
        require_once $_SERVER['DOCUMENT_ROOT'].'/classes/op_codes.php';
     ...
     */
    public function GetCatalogPositionsTable($clear_cache = false)
    {
        $memBuff = new memBuff();
     ...
     */
    public function RecalcCatalogPositions()
    {
        if ($GLOBALS['DB']->mquery('SELECT recalc_catalog_positions()')) {
            return 0;
        }

        self::GetCatalogPositionsTable(1);
     ...
     */
    public function updateAvgPrices($data)
    {
        global $DB;
        $DB->clear();
     ...
     * @return array $rows 
     * */
    public function GetProfessionsAndGroup($order_by = 'gid')
    {
        global $DB;
      ...
      * */
     public function GetProfessionsTitles($ids)
     {
         $ids = implode(',', $ids);
         $DB = new DB('master');
    ...
    public static function getLastModifiedSpec($uid)
    {
        ...
        if ($spec['new_spec'] == 0 || $spec['old_spec'] == $spec['new_spec']) {
            // Если нулевая меняй сколько хочешь
