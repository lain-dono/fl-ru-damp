...
class users_suspicious_contacts
{
     ...
     */
    public function setResetContacts()
    {
        $nRet = 0;
     ...
     */
    public function getResetContacts()
    {
     ...
     */
    public function resolveContacts($sid = '')
    {
     ...
     */
    public function massResolveContacts($sid = array())
    {
     ...
     * @return array
     */
    public function getContacts($prefix = '', $page = 1, $order = 'ASC')
    {
     ...
     * @return string
     */
    public function getWhere($sFld = '', $sOr = '')
    {
     ...
     * @return int
     */
    public function countContacts($prefix = '')
    {
