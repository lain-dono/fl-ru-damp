...
class sms_gate_a1 extends sms_gate
{
    ...
    public static $enable_link_css = 'b-layout__link_bordbot_dot_0f71c8';
    public static $disable_link_css = 'b-layout__link_bordbot_dot_80';
     ...
     * @param int  $recId  = 0  номер записи для обновления
     *
     * @return bool
     **/
