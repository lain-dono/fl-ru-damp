 ...
 *
	 ...
	 */
	public function Add($user_id, $target_login, $text, $rating = 0, $old = '?i')
	{
	    $DB = new DB();
 ...
 *
	 * @return string Сообщение об ошибке
	 */
	public function Update($user_id, $target_login, $text, $rating = 0, $old = '?i')
	{
	    $DB = new DB();
	    if (empty($user_id) || empty($target_login) || empty($text)) {
 ...
 *
	 ...
	 */
	public function GetNotes($from_id, $to_login = false, &$error)
	{
	    $DB = new DB();
	    if (!$from_id) {
	        return false;
 ...
 *
	 * @return array данные выборки
	 */
	public function GetNote($from_id, $to_id, &$error = false)
	{
	    $DB = new DB();
 ...
 *
	 * @return array данные выборки
	 */
	public function GetNoteInt($from_id, $to_id, &$error = false)
	{
	    $DB = new DB();
 ...
 *
	 ...
	 */
	public function DeleteNote($user_id, $to_uid, $old = '?i')
	{
	    $DB = new DB();
