 ...
 *
	 ...
	 */
	public function teamsAddFavorites($user_id, $target, $by_login = true)
	{
	    $DB = new DB();
	    $error = '';
 ...
 *
	 * @return array 
	 */
	public function teamsInFrlFavorites($for_whom, &$error)
	{
	    $users = new users();
 ...
 *
	 * @return array
	 */
	public function teamsInEmpFavorites($whom, &$error)
	{
	    $users = new users();
 ...
 *
	 * @return array
	 */
	public function teamsFavorites($whom, &$error, $bIsLogin = false)
	{ // Я рекомендую.
		$DB = new DB();
 ...
 *
	 * @return array
	 */
	public function teamsFavoritesCount($whom, &$error, $bIsLogin = false)
	{ // Я рекомендую.
		$DB = new DB();
 ...
 *
	 * @return string Сообщение об ошибке
	 */
	public function teamsDelFavoritesExcept($user_id, $selected)
	{
	    $DB = new DB();
	    if (empty($user_id)) {
 ...
 *
	 ...
	 */
	public function teamsInverseFavorites($login)
	{
	    $r = 1;
	    $DB = new DB();
	 ...
	 */
	public function teamsDelFavorites()
	{
	    $DB = new DB();
     ...
     */    
	public function teamsDelFavoritesByLogin($user_id, $target_login)
	{
	    $DB = new DB();
	    $error = '';
     ...
     */
    public function teamsIsInFavorites($user_id, $target_id)
    {
        $DB = new DB();
