...
class ReservesChangeStatusForm extends Form_View
{
    ...
    public function init()
    {
        ...
        $options = array(
            '' => 'Выберите статус',
            ReservesAdminOrderModel::ReserveOrderStatus_Reserve => $default[ReservesAdminOrderModel::ReserveOrderStatus_Reserve],
            ReservesAdminOrderModel::ReserveOrderStatus_InWork => $default[ReservesAdminOrderModel::ReserveOrderStatus_InWork],
