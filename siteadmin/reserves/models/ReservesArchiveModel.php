...
{
    public static $_TABLE_FILE = 'file_reserves_doc_archive';
    public static $_TABLE_ARCHIVE = 'reserves_doc_archive';
    public static $_TABLE_RESERVE_TO_LETTER = 'reserves_to_letters';
