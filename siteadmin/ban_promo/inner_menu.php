...
<table class="payed-compar" style="border:1px silver solid" cellspacing="0" id="bannerlist">
    ...
    ?>><?php print $banner_promo_text?></a>
            ...
            <td <?=($banner['is_activity'] == 't' ? 'class="td-pro"' : '')?> style="border-left:1px silver solid; border-right:1px silver solid"><?= date('d.m.Y', strtotime($banner['from_date']));
    ?> - <?=date('d.m.Y', strtotime($banner['to_date']))?></td>
