...
<tr class="box4">
	...
	<td colspan="12" title="Изменение счетов всех пользователей c 12 декабря 2000 года до начала периода выборки"><?= $ost_b[$i];
    ?> руб.</td>
</tr>
<tr class="box4">
