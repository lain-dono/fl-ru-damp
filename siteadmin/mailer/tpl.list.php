<table class="b-layout__table b-layout__table_width_full b-layout__table_margbot_20" border="0" cellpadding="0" cellspacing="0">
    ...
    } elseif ($content['filter_frl'] > 0) {
        $class_role = 'b-username__role_frl';
    } elseif ($content['filter_emp'] > 0) {
    ...
    ?>
    <tr class="b-layout__tr <?= $content['status_sending'] == 2 ? 'b-layout__tr_loadfon' : '';
    ?><?/*b-layout__tr_loadfon*/?>">
    ...
    echo number_format(($content['is_digest'] !== null ? $sum_digest : $sum), 0, ',', ' ');
}
    ?>
        ...
        <td class="b-layout__one b-layout__one_padbot_5 b-layout__one_padtop_2 ">
            <div class="b-layout__txt b-layout__txt_padright_10 <?php if (!(($content['status_sending'] == 3) || ($content['type_regular'] > 1 && $content['status_sending'] != 3))) {
    ?>b-layout__txt_padleft_15<?php 
}//if?>">
    ...
    ?>
                ...
                <a class="b-layout__link <?=$mailer->getColorMailer($content);
    ?>"  href="<?= $link?>"><?= reformat(stripslashes($content['subject']), 45);
    ?></a>
            </div>
        </td>
        <td class="b-layout__one b-layout__one_padbot_5 b-layout__one_padtop_2 ">
