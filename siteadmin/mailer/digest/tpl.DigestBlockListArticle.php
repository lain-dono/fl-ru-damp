...
<table style="margin-top: 0pt; margin-left: auto; margin-right: auto; background-color: #ffffff; text-align:left" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="740">
    ...
    ?>
        <tr>
            ...
            <td  width="20"></td>
            <td >
                <font color="#444444" size="2" face="arial,sans-serif"><a href="<?= $this->getLinkById($article['id']);
    ?>" style="color:#0F71C8" target="_blank" ><?= $article['title'];
    ?></a></font>
            </td>
            <td  width="20"></td>
            <td  bgcolor="#ffffff" width="20"></td>
        ...
        <tr>
            ...
            <td  width="20"></td>
            <td >
                <font color="#4d4d4d" size="1" face="arial,sans-serif"><?= date('d.m.Y', strtotime($article['post_time']));
    ?></font>
            </td>
            <td  width="20"></td>
            <td  bgcolor="#ffffff" width="20"></td>
