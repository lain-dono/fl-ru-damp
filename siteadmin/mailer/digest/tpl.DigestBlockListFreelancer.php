...
<table style="margin-top: 0pt; margin-left: auto; margin-right: auto; background-color: #ffffff; text-align:left" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="740">
    ...
    ?>
            ...
            <td width="60" >
                <a href="<?= $this->host;
    ?>/users/<?= $user['login']?>" target="_blank" border="0">
                <?= view_avatar($user['login'], $user['photo'])?>
                </a>
            </td>
            <td >
                <font color="#000000" size="2" face="arial,sans-serif"><a href="<?= $this->host;
    ?>/users/<?= $user['login']?>" style="color:#000000" target="_blank"><?= ($user['uname'].' '.$user['usurname']);
    ?></a></font><br>
                <font color="#fd6c30" size="2" face="arial,sans-serif">[<a href="<?= $this->host;
    ?>/users/<?= $user['login']?>" style="color:#fd6c30" target="_blank"><?= $user['login']?></a>]</font><br>
