...
<div class="b-fon b-fon_padbot_30">
    ...
    ?>
                    <textarea id="<?= $this->__toString();
    ?>Descr_<?= $this->getPosition();
    ?>" class="ckeditor" cols="" rows="" name="<?= $this->__toString();
    ?>Descr<?= $this->isMore();
    ?>" ><?= $this->text;
    ?></textarea>
                    <?php 
                    ...
                    <div class="b-textarea">
                        <textarea class="b-textarea__textarea" cols="" rows="" name="<?= $this->__toString();
    ?>Descr<?= $this->isMore();
    ?>" autocomplete="off"><?= $this->text;
    ?></textarea>
                    </div>
                    <?php 
}//else?>
