<div id="filter_freelancer" class="b-layout__inner b-layout__inner_bordtop_c6 b-layout__inner_bordbot_c6 b-layout__inner_margbot_30 b-layout__inner_padtb_20 <?= ($message['filter_frl'] ? '' : 'b-layout__inner_hide')?>">
    ...
    ?>
	<?php include 'subfilter/tpl.finance.php'; ?>			
	<?php unset($finance_name, $finance_check); ?>			
		
    <?php $buying_check = 'fbuying'; ?>
    ...
    ?>
    <?php include 'subfilter/tpl.buying.php'; ?>
    <?php unset($buying_name, $buying_check, $op_codes); ?>			
	...
	<?php include 'subfilter/tpl.fproject.php'; ?>			
	...
	<?php include 'subfilter/tpl.specs.php'; ?>			
	...
	<?php include 'subfilter/tpl.blogs.php'; ?>			
	...
	<?php include 'subfilter/tpl.location.php'; ?>
