<div class="cl-form">
    <div class="cl-form-in">
        ...
        <div>
            <?php if ($error['msgtext']) {
    ?><div style="color:red"><?=$error['msgtext']?></div><?php 
} ?>
    ...
    ?>
                    <ul class="form-files-added">
                        <?php foreach ($msg['attach'] as $id => $a) {
    if ($msg['delattach'][$id]) {
        continue;
    }
    ?>
    ...
    ?>
                    ...
                    <?php if ($error['attach']) {
    ?><div style="color:red"><?=$error['attach']?></div><?php 
} ?>
            ...
            <div class="cl-form-video" id="msgs_yt_box<?=$msg['id']?>" style="height:auto">
                <?php if ($error['yt_link']) {
    ?><div style="color:red"><?=$error['yt_link']?></div><?php 
} ?>
    ...
    ?>" />
            ...
            <?php if ($msg['delattach']) {
    foreach ($msg['delattach'] as $id) {
        ?>
