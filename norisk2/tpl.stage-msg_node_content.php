...
<div class="user-info">
    ...
    <?php if (($msg['attach'] || $msg['yt_link']) && (!$msg['deluser_id'] || $this->sbr->isAdmin())) {
    ?>
    ...
    ?>
					<ul class="cl-o">
							...
							<?php if ($msg['user_id'] == $stage->sbr->uid && !$msg['deluser_id'] && $stage->checkMsgEditTime($msg['post_date']) || $this->sbr->isAdmin()) {
    ?>
									<li class="cl-edit"><a href="javascript:;" onclick="SBR_STAGE.getMsgForm(<?=$msg['id']?>, 1)">Редактировать</a></li>
									<li class="cl-del"><a href="javascript:;" onclick="SBR_STAGE.delMsg(<?=$msg['id']?>)">Удалить</a></li> <?php // !!! "Вернуть" ?>
							<?php 
}
    ?>
							<?php /* <li class="last"><a href="" class="cl-thread-toggle">Свернуть ветвь</a></li> */ ?>
					</ul>
        <?php 
}//if?>
</div>
