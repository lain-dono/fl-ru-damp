...
<?php 
    ...
    ?><a href="#c_0" class="btngr btn-right" onclick="window.setTimeout('document.getElementById(\'msg_form0\').msgtext.focus()',0)"><span class="btn-lc"><span class="btn-m"><span class="btn-txt">Добавить комментарий</span></span></span></a><?php 
}//if?>
		...
		<div class="nr-discuss-comment">
            ...
            <div id="msg_form_box0">
                ...
                if ($stage->post_msg && !$stage->post_msg['parent_id'] && !$stage->post_msg['id']) {
                    ...
                    echo $stage->msg_form(array('stage_id' => $stage->id, 'id' => '0'), NULL, true);
                } // !!! нужно вместо 0 что-нибудь другое.
                ?>
            </div>
		</div>
		<?php 
