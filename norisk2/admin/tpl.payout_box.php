<div class="overlay ov-out yd-overlay" id="payout_box" style="z-index:10000">
        ...
        <div class="ov-l">
            <div class="ov-in">
                ...
                <div>
                  ...
                  <?php if ($pmt['amt_sys'] == exrates::WMR) {
    ?>
    ...
    ?>
                   ...
                   <?php if (isset($pmt['balance']) && $pmt['balance'] < ($pmt['in_amt'] - $pmt['out_amt'])) {
    ?>
    ...
    ?>
                      ...
                      <?php if ($pmt['in_amt'] > $pmt['out_amt'] && !$stage->payouts[$user_id]['completed']) {
    ?>
