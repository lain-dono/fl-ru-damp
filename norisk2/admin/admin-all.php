...
<div class="norisk-admin c">
	<div class="norisk-in">
        ...
        <div>
            <table class="nr-a-tbl" cellspacing="5" style="table-layout:fixed">
                ...
                <thead>
                    <tr>
                        <?php foreach ($sbr->form_cols['all'] as $idx => $val) {
    ?>
                    ...
                    <tr class="pd">
                        ...
                        <td><select name="filter[cost_sys]" onchange="SBR.form.submit()">
                          ...
                          <?php foreach ($EXRATE_CODES as $exc => $exn) {
    ?>
                        ...
                        <td><select name="filter[status]" onchange="SBR.form.submit()">
                          ...
                          <?php foreach (sbr_stages::$ss_classes as $st => $ssc) {
    ?>
                ...
                <tbody>
                    <?php foreach ($sbr_all['data'] as $sbr_data) {
    ...
    ?>
                    <tr class="<?=(++$i % 2 == 0 ? 'even' : 'odd')?>">
                        ...
                        <td class="nr-a-td-val"><?= ($sbr_data['reserved_id'] || $sbr_data['scheme_type'] != sbr::SCHEME_LC ? $EXRATE_CODES[$sbr_data['cost_sys']][2] : ' &mdash; ');
    ?></td>
