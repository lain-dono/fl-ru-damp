<?php if ($sbr->status == sbr::STATUS_PROCESS && !$sbr->data['reserved_id'] && $sbr->state != 'new') {
    ?>
<div class="b-fon b-fon_width_full">
    <div class="b-fon__body b-fon__body_pad_10 b-fon__body_padleft_30 b-fon__body_fontsize_13 b-fon__body_bg_ffeeeb">
        ...
        Исполнитель не приступит к работе, пока вы не <a class="b-fon__link" href="/<?= sbr::NEW_TEMPLATE_SBR;
    ?>/?site=reserve&id=<?= $sbr->id?>">зарезервируете деньги</a> под сделку.
	</div>
</div>	
<?php 
...
<?php if ($stage->status == sbr_stages::STATUS_COMPLETED && !$stage->data['emp_feedback_id']) {
    ?>
<div class="b-fon b-fon_width_full">
    <div class="b-fon__body b-fon__body_pad_10 b-fon__body_padleft_30 b-fon__body_fontsize_13 b-fon__body_bg_f0ffdf">
        <?php if ($sbr->status == sbr::STATUS_COMPLETED) {
    ?>
