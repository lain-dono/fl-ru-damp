<?php if (!$curr_sbr->reserved_id && $curr_sbr->status == sbr::STATUS_PROCESS && $curr_sbr->state != 'new') {
    ?>
<div class="b-buttons b-buttons_padtop_15 b-buttons_padbot_15 b-buttons_padleft_17">
    <a class="b-button b-button_flat b-button_flat_grey" href="/<?= sbr::NEW_TEMPLATE_SBR;
    ?>/?site=reserve&id=<?= $curr_sbr->id;
    ?>">Зарезервировать деньги</a>
