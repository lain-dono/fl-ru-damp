...
<table class="b-layout__table b-layout__table_width_full" cellspacing="0" cellpadding="0" border="0">
    <tbody>
        <tr class="b-layout__tr">
            <td class="b-layout__left b-layout__left_width_72ps">
                <?php if ($lc['state'] == pskb::STATE_NEW) {
    ?>
    ...
    ?>  
                        <div class="b-layout__txt b-layout__txt_padbot_10"><img src="/images/loading-green.gif" style="float:left;margin-right:10px;">
                            Идет оплата. Это может занять от нескольких секунд до нескольких минут. <a class="b-layout__link" href="/<?= sbr::NEW_TEMPLATE_SBR;
    ?>/?site=reserve&id=<?= $sbr->data['id'] ?>">Проверить статус оплаты</a><br />
    ...
    ?>
                        ...
                        <?php if ($lc['sended'] != 1 && $lc['ps_emp'] != onlinedengi::BANK_YL) {
    ?>
    ...
    ?>" />
                        ...
                        <div class="b-layout__txt b-layout__txt_padbot_10 b-layout__txt_padtop_10"><a class="b-layout__link" href="/<?= sbr::NEW_TEMPLATE_SBR;
    ...
    ?>
                        <table cellspacing="0" cellpadding="0" border="0" class="b-layout__table">
                            <tbody>
                                <tr class="b-layout__tr">
                                    <td class="b-layout__middle b-layout__middle_padbot_5"><div class="b-layout__txt"><i class="b-icon b-icon_attach_pdf"></i> <a class="b-layout__link" href="<?= WDCPREFIX;
    ?>/<?=$doc_file->path.$doc_file->name?>"><?= $doc_file->original_name?></a>, <?= ConvertBtoMB($doc_file->size)?></div></td>
    ...
    ?>/<?=$doc_file->path.$doc_file->name?>">Скачать файл</a></div></td>
                                </tr>
                            </tbody>
                        </table>
                        <?php 
    ...
    ?>
                ...
                <?php if ($lc['state'] == pskb::STATE_FORM) {
    ?>
                <div class="b-fon b-fon_width_full">
                    <div class="b-fon__body b-fon__body_pad_10 b-fon__body_padleft_30 b-fon__body_fontsize_13 b-fon__body_bg_f0ffdf">
...
<?php if ($sbr->isEmp()) {
    $disable_reload = true;
    include_once $_SERVER['DOCUMENT_ROOT'].'/sbr/employer/tpl.pskb-cards.php';
} ?>