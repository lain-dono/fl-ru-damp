...
<?php foreach ($sbr_drafts as $sbr_id => $curr_sbr) {
    ?>
            ...
            <tbody>
                <tr class="b-layout__tr">
                    <td class="b-layout__left b-layout__left_pad_5_15 b-layout__hover_bg_f2f4f5">
                        <span class="i-button"><a class="b-button b-button_admin_del b-button_float_right b-button_margtop_7" href="javascript:void(0)" onclick="if(confirm('Вы хотите удалить черновик?')) xajax_deleteDraftSbr(<?= $sbr_id;
    ?>);"></a></span>
