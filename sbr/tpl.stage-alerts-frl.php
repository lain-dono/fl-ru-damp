<?php if ($sbr->status == sbr::STATUS_PROCESS && !$sbr->data['reserved_id']) {
    ?>
...
<?php if ($stage->status == sbr_stages::STATUS_PROCESS && $sbr->data['reserved_id']) {
    ?>
<div class="b-fon b-fon_width_full">
...
<?php if ($stage->status == sbr_stages::STATUS_COMPLETED && $stage->notification['ntype'] == 'sbr_stages.FRL_FEEDBACK') {
    ?>
<div class="b-fon b-fon_width_full">
    <div class="b-fon__body b-fon__body_pad_10 b-fon__body_padleft_30 b-fon__body_fontsize_13 b-fon__body_bg_f0ffdf">
...
<?php if ($stage->status == sbr_stages::STATUS_COMPLETED && !$stage->data['frl_feedback_id'] && $stage->sbr->scheme_type == sbr::SCHEME_LC) {
