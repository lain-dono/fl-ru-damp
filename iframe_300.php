...
<html>
	<head>
        <script type="text/javascript" src="<?=WDCPREFIX?>/scripts/swfobject.js"></script> <?php // должен быть линк на папку /scripts в папке вебдава ?>
		<style>
			*{
				margin: 0;
				padding: 0;
    ...
    ?>
        ...
        <?php 
            ...
            ?><img src="/images/dot_grey.gif" alt="" width="300" height="60" />
        <?php 
        } ?></span>
		</div>
	</body>
