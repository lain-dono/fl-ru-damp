...
<div id="b_ext_filter" class="b-layout ">
            ...
            <table class="b-layout__table b-layout__table_width_full b-layout__table_margbot_30 b-layout_margbot_20_ipad">
               <tr class="b-layout__tr">
                  <td class="b-layout__td b-layout__td_padright_10 b-layout__td_valign_bot">
                      <div class="b-layout__txt b-layout__txt_bold b-layout__txt_padbot_5"><?php if (!(get_uid(false) && !is_emp())) {
    ?>Что вы хотите заказать<?php 
} else {
    ?>Поиск услуг<?php 
} ?></div>
                      <div class="b-combo">
    ...
    ?>
                          <a href="<?php echo sprintf(tservices_helper::url('new'), $_SESSION['login']);
    ?>" class="b-button b-button_flat b-button_flat_green b-button_padlr_10 b-button_nowrap b-button_block" onClick="yaCounter6051055.reachGoal('add_new_tu');">Добавить услугу</a>
					  <?php 
}
    ?>
                  </td>
