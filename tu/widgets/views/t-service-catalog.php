...
<div class="b-catalog b-fon b-fon_bg_74bb54">
    ...
    ?>
							<ul id="submenu<?=$i?>" class="element b-catalog__inner-list" <?php if (is_null($parentCategory['category_id'])) {
    ?>style="display: block !important;"<?php 
}
    ?>>
    ...
    ?>
								...
								<?php 
} // foreach($parentCategory['children'] as $j => $childCategory) ?>
