                    ...
                    <table class="b-layout__table">
                        <tr class="b-layout__tr">
                            <td class="b-layout__td b-layout__td_width_full">
                                <div class="b-combo">
                                    <div class="b-combo__input <?php if (isset($errors['title'])) {
    ?> b-combo__input_error<?php 
} ?>">
                            ...
                            <td class="b-layout__td b-layout__txt_nowrap">
                                ...
                                <div class="b-combo b-combo_inline-block">
                                    <div class="b-combo__input b-combo__input_width_90<?php if (isset($errors['price'])) {
    ?> b-combo__input_error<?php 
} ?>">
                ...
                <td class="b-layout__td b-layout__td_padbot_30">
                   ...
                   <div class="b-combo">
                      <div class="
                           ...
                           sort_cnt 
                           <?php if ($is_exist_feedbacks > 0) {
    ?>b-combo__input_disabled<?php 
} ?> 
    ...
    ?>b-combo__input_error<?php 
            ...
            <tr class="b-layout__tr">
                <td class="b-layout__td b-layout__td_padbot_30">
                    ...
                    <div class="b-combo">
                        <div class="b-combo__input b-combo__input_max-width_500<?php if (isset($errors['tags'])) {
    ?> b-combo__input_error<?php 
} ?>">
            ...
            <tr class="b-layout__tr">
                <td class="b-layout__td b-layout__td_padbot_30">
                    ...
                    <?php
                        if (!$tservice->videos) {
                            $tservice->videos = array(array('url' => ''));
                        }
                        ...
                        <tr class="b-layout__tr">
                            <td class="b-layout__td b-layout__td_width_500 b-layout__td_ipad">
                                <div class="b-combo b-combo__input_max-width_500">
                                    <div class="b-combo__input<?php if (isset($errors['videos'][$key])) {
    ?> b-combo__input_error<?php 
}
                            ?>">
            ...
            <tr class="b-layout__tr">
                <td class="b-layout__td b-layout__td_padbot_30">
                    ...
                    <div class="b-textarea b-textarea_max-width_500<?php if (isset($errors['description'])) {
    ?> b-textarea_error<?php 
} ?>">
            ...
            <tr class="b-layout__tr">
                <td class="b-layout__td b-layout__td_padbot_30 b-layout__td_bordbot_c3">
                    ...
                    <?php 
                        if (!$tservice->extra) {
                            $tservice->extra = array(array('title' => '','price' => '','days' => 1));
                        }
                    ?>
                    <div id="extra_items">
                    <?php
                    ...
                    <table class="b-layout__table b-layout__table_width_full b-layout__table_margbot_10">
                        <tr class="b-layout__tr">
                            <td class="b-layout__td b-layout__td_width_full">
                                <div class="b-combo">
                                    <div class="b-combo__input<?php if (isset($errors['extra'][$key]['title'])) {
    ?> b-combo__input_error<?php 
}
                            ?>">
                            ...
                            <td class="b-layout__td b-layout__txt_nowrap">
                                <span class="b-txt b-txt_inline-block b-txt_padtop_3 b-txt_padlr_5">&nbsp;за&nbsp;</span>
                                <div class="b-combo b-combo_inline-block">
                                    <div class="b-combo__input b-combo__input_width_90<?php if (isset($errors['extra'][$key]['price'])) {
    ?> b-combo__input_error<?php 
}
                            ?>">
                                ...
                                <span class="b-txt b-txt_inline-block b-txt_padtop_3">&nbsp;<?php echo tservices_const::enum('currency', 'rus');
                            ?></span>
                            ...
                            <td class="b-layout__td b-layout__txt_nowrap">
                                ...
                                <div class="b-combo b-combo_inline-block">
                                    <div class="
                                         ...
                                         <?php if (isset($errors['extra'][$key]['days'])) {
    ?>b-combo__input_error<?php 
}
                            ?> 
                                         b-combo__input_arrow_yes">
            ...
            <tr class="b-layout__tr">
                <td class="b-layout__td b-layout__td_padbot_15 b-layout__td_padtop_15">
                    <div class="b-check b-check_inline-block b-check_padtop_5 b-check_padbot_5 b-check_padright_5">
                          <input tabindex="207"<?php if ($tservice->is_express == 't') {
    ?> checked="checked"<?php 
} ?> type="checkbox" value="1" name="express_activate" class="b-check__input" id="express_activate"/>
                    ...
                    <span class="b-layout_block_iphone">
                        <div class="b-combo b-combo_inline-block">
                            <div class="b-combo__input b-combo__input_width_90<?php if ($tservice->is_express == 'f') {
    ?> b-combo__input_disabled<?php 
} ?><?php if (isset($errors['express']['price'])) {
    ?> b-combo__input_error<?php 
} ?>">
                                <input tabindex="208" maxlength="6" data-validators="<?php if ($tservice->is_express == 't') {
    ?>required uint<?php 
} ?>" id="express[price]" type="text" name="express[price]" class="b-combo__input-text" value="<?php echo(($tservice->express_price > 0) ? $tservice->express_price : '') ?>"<?php if ($tservice->is_express == 'f') {
                        ...
                        <span class="b-layout_block_iphone b-layout_padtop_7">
                            <div class="b-combo b-combo_inline-block">
                                <div class="
                                     ...
                                     disallow_null 
                                     b-combo__input_init_tuDayList 
                                     <?php if (isset($errors['express']['days'])) {
    ?>b-combo__input_error<?php 
} ?> 
                                     <?php if ($tservice->is_express == 'f') {
    ?>b-combo__input_disabled<?php 
} ?>">
                                    <input tabindex="209" id="express[days]" type="text" value="" name="express[days]" readonly="readonly" class="b-combo__input-text b-combo__input-text_pointer"<?php if ($tservice->is_express == 'f') {
    ?> disabled="disabled"<?php 
} ?>/>
            ...
            <tr class="b-layout__tr">
                <td class="b-layout__td b-layout__td_padbot_30 b-layout__td_padtop_15">
                    ...
                    <div class="b-textarea b-textarea_max-width_500<?php if (isset($errors['requirement'])) {
    ?> b-textarea_error<?php 
} ?>">
                ...
                <td class="b-layout__td b-layout__td_padbot_30">
                    ...
                    <div class="b-radio b-radio_layout_vertical">
                        ...
                        <div class="b-radio__item b-radio__item_padbot_10">
                            <input tabindex="211"<?php if ($tservice->is_meet == 'f') {
    ?> checked="checked"<?php 
} ?> type="radio" value="1" name="distance" class="b-radio__input" id="distance"/>
                            <label for="distance" class="b-radio__label b-radio__label_ptsans b-radio__label_margtop_-1">
                                Удаленно
                            </label>
                        </div>
                        <div class="b-radio__item">
                            <input tabindex="212"<?php if ($tservice->is_meet == 't') {
    ?> checked="checked"<?php 
} ?> type="radio" value="2" name="distance" class="b-radio__input" id="personal">
                    ...
                    <table  class="b-layout__table b-layout__table_width_full chk-tu-tbl">
                        <tr class="b-layout__tr">
                            <td class="b-layout__td b-layout__td_padright_10">
                                <div class="b-check">
                                    <input tabindex="214" title="Необходимо согласиться с условиями размещения" data-validators="" type="checkbox" value="1" name="agree" class="b-check__input validate-required-check" id="agree" <?php if ($tservice->agree === 't') {
    ?>checked="checked"<?php 
} ?>/>
                                </div>    
                            </td>
