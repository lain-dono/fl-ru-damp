...
<?php endif;
    ...
    <div class="i-pic i-pic_port i-pic_port_z-index_inherit i-pic_pad_10 i-pic_height_265<?php if (!$tservice['is_binded']):?> i-pic_margbot_30 i-pic_bord_green_hover<?php if ($hide_block): ?><?=' b-layout_hide'?><?php endif;
    ?><?php endif;
    ?>">
