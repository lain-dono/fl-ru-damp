...
<div class="b-layout__side b-layout__side_margbot_30">
    ...
    continue;
        ...
        ?>
            <li class="b-gallery__item <?php if ($hide_vds) {
    ?>b-gallery__item_display_none<?php 
}
        ?>">
                <a data-type="video" data-autoplay="<?php if ($key > 0) {
    ?>1<?php 
} else {
    ?>0<?php 
}
        ?>" data-source="<?php echo $video['video'];
    ...
    foreach ($data['images'] as $key => $image) {
        ?>
            <li class="b-gallery__item <?php if ($hide_img) {
    ?>b-gallery__item_display_none<?php 
}
        ?>">
    ...
    foreach ($data['extra'] as $key => $el) {
        ...
        ?>
           <tr class="b-layout__tr">
               <td class="b-layout__td b-layout__td_padtb_15 <?php if (!$is_last) {
    ?> b-layout__td_bordbot_c3<?php 
}
        ?>">
                   <input type="checkbox" data-price="<?php echo $el['price'];
        ?>" data-days="<?php echo $el['days'];
        ?>" value="<?php echo $key ?>" name="extra[]" class="b-check b-check__input __tservice_on_extra" id="extra_<?php echo $key ?>">
               </td>
               <td class="b-layout__td b-layout__td_padleft_15 b-layout__td_padtb_15 b-layout__td_width_full<?php if (!$is_last) {
    ?> b-layout__td_bordbot_c3<?php 
}
        ?>">
    ...
    ?>
        ...
        ?>
               ...
               <td class="b-layout__td b-layout__td_padleft_15 b-layout__td_padright_35 b-layout__td_padtb_15 b-layout__td_nowrap b-layout__td_right b-layout__td_line-height_1 b-post__price_ptsans<?php if (!$is_last) {
    ?> b-layout__td_bordbot_c3<?php 
}
        ?>">
           ...
           <tr class="b-layout__tr">
               ...
               <td class="b-layout__td b-layout__td_padleft_15 b-layout__td_padtb_15 b-layout__td_width_full b-layout__td_line-height_1">
                   <label class="b-check__label b-check__label_ptsans" for="is_express">
                       Могу выполнить срочно за <strong><?php echo $data['express_days'];
    ?> <?php echo ending($data['express_days'], 'день', 'дня', 'дней');
    ?></strong>
                   </label>
               </td>
...
<div class="b-layout__side <?php if (count($feedbacks)) {
    ?>b-layout__side_margbot_40<?php 
} ?>">
