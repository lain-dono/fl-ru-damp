...
if ($fromSearchAction === 'search_advanced') {
    ...
    <?php $searchValuesSBR = __paramInit('array', 'success_sbr', 'success_sbr', array(false, false, false));
    ?>
    ...
    <?php $searchValuesExp = __paramInit('array', 'exp', 'exp', array());
    ?>
    ...
    <?php $searchValuesAge = __paramInit('array', 'age', 'age', array());
    ?>
    ...
    <?php $searchValuesProf = __paramInit('array', 'pf_categofy', 'pf_categofy', array());
