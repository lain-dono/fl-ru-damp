...
class VisitSession
{
    ...
    public function UpdateVisitSession($visitsessionid, $params = array())
    {
    ...
    public function UnsetVisitSession()
    {
  ...
  public function updateCurrentOrCreateSession()
  {
    ...
    public function GetVisitSessionByPageId($pageid)
    {
        $vistedpage = VisitedPage::GetInstance()->GetVisitedPageById($pageid);

        return self::GetInstance()->GetVisitSessionById($vistedpage['visitsessionid']);
    }

    public function GetVisitSessionTime($visitSessionId)
    {
        return MapperFactory::getMapper('VisitedPage')->getVisitTimeByVisitSessionId($visitSessionId);
    }

    public function EnumVisitedPagesBySessionId($visitSessionId)
    {
        return MapperFactory::getMapper('VisitedPage')->enumByVisitSessionId($visitSessionId);
    }

    public function GetVisitSessionById($visitsessionid)
    {
        return MapperFactory::getMapper('VisitSession')->getById($visitsessionid);
    }

    public static function GetPartnerReference($visitSessionId)
